...
func ValidateAWSResources(ctx context.Context, t *retry.R, expected *AWSResourceSet, client awsclient.AWSCloudControlClient) {
...
func assertFieldsArePresent(t *retry.R, actual any, expected any) {
