...
# `kind-radius` environment within the `default` group.
...
resourcegroup=$1
echo "Creating Azure resources in resource group $resourcegroup"
...
echo "Created Azure Cosmos MongoDB account with ID $AZURE_COSMOS_MONGODB_ACCOUNT_ID"
