  ...
  properties: {
    recipes: {
      ...
      'Test.Resources/postgres': {
        ...
        location: '${registry}/test/testrecipes/test-bicep-recipes/dynamicrp_postgress_recipe@sha256:40d079856c2b7cf4df146c0726b31b8bea6a82ef1eb7fa9bc9e00498367f2a4d'
      }
    }
  }
}
