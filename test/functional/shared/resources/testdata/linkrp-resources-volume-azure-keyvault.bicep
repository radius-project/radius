...
resource env 'Applications.Core/environments@2022-03-15-privatepreview' = {
  name: 'linkrp-azure-workload-env'
  location: location
  properties: {
    compute: {
      kind: 'kubernetes'
      resourceId: 'self'
      namespace: 'linkrp-azure-workload-env'
      identity: {
...
resource app 'Applications.Core/applications@2022-03-15-privatepreview' = {
  name: 'linkrp-resources-volume-azure-keyvault'
  location: location
  properties: {
    environment: env.id
    extensions: [
      {
          ...
          namespace: 'linkrp-resources-volume-azure-keyvault-app'
      }
    ]
  }
}
...
resource azTestKeyvault 'Microsoft.KeyVault/vaults@2022-07-01' = {
  ...
  tags: {
    radiustest: 'linkrp-resources-key-vault'
  }
  properties: {
