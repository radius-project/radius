			...
			Components: &validation.ComponentSet{
				Components: []validation.Component{
					...
					},
					{
						...
						OutputResources: map[string]validation.ExpectedOutputResource{
							outputresource.LocalIDAzureServiceBusTopic: validation.NewOutputResource(outputresource.LocalIDAzureServiceBusTopic, outputresource.TypeARM, resourcekinds.KindDaprPubSubTopicAzureServiceBus, true, false, rest.OutputResourceStatus{}),
						},
					},
				},
			},
			...
			Components: &validation.ComponentSet{
				Components: []validation.Component{
					...
					},
					{
						...
						ComponentName:   "pubsub",
						OutputResources: map[string]validation.ExpectedOutputResource{
							outputresource.LocalIDAzureServiceBusTopic: validation.NewOutputResource(outputresource.LocalIDAzureServiceBusTopic, outputresource.TypeARM, resourcekinds.KindDaprPubSubTopicAzureServiceBus, false, false, rest.OutputResourceStatus{}),
						},
					},
				},
			},
