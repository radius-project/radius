...
func TestGeneric(t *testing.T) {
	template := "testdata/kubernetes-resources-generic.bicep"
	application := "kubernetes-resources-generic"
				...
				Resources: []validation.RadiusResource{
					{
						...
						OutputResources: map[string]validation.ExpectedOutputResource{
							...
							outputresource.LocalIDGeneric: validation.NewOutputResource(
								outputresource.LocalIDGeneric,
								outputresource.TypeKubernetes,
								resourcekinds.Kubernetes, false, rest.OutputResourceStatus{}),
						},
					},
