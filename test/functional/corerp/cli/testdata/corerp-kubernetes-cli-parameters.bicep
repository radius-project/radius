...
resource parametersApp 'Applications.Core/applications@2023-04-15-preview' = {
...
resource containerc 'Applications.Core/containers@2023-04-15-preview' = {
  name: 'containerC'
  location: location
  properties: {
...
resource containerd 'Applications.Core/containers@2023-04-15-preview' = {
  name: 'containerD'
  location: location
  properties: {
    application: parametersApp.id
