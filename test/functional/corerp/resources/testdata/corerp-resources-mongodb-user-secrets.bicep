...
resource mongoContainer 'Applications.Core/containers@2023-04-15-preview' = {
  name: 'mdb-us-ctnr'
  location: 'global'
  properties: {
    application: app.id
...
resource mongoRoute 'Applications.Core/httproutes@2023-04-15-preview' = {
  name: 'mdb-us-rte'
  location: 'global'
  properties: {
    application: app.id
...
resource mongo 'Applications.Link/mongoDatabases@2023-04-15-preview' = {
  name: 'mdb-us-db'
  location: 'global'
  properties: {
    application: app.id
