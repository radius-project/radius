...
// Replace controller-runtime with a pre-release commit from main that supports
// k8s.io v0.36.0. The released v0.23.3 is only compatible with k8s.io v0.35.x
// and fails to compile with v0.36.0 (missing HasSyncedChecker method).
// Remove this replace once controller-runtime v0.24.0+ is released.
replace sigs.k8s.io/controller-runtime => sigs.k8s.io/controller-runtime v0.23.1-0.20260418192536-e4a998cc6b09
...
require (
	...
	sigs.k8s.io/controller-runtime v0.23.1 // see replace directive above
