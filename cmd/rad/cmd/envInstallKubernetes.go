...
func init() {
	...
	envInstallKubernetesCmd.Flags().StringP("name", "n", "", "The name to use for the environment")
	...
	envInstallKubernetesCmd.Flags().String("namespace", "default", "The namespace to use for the environment")
