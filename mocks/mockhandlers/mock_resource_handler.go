...
// Source: github.com/Azure/radius/pkg/radrp/handlers (interfaces: ResourceHandler)
...
import (
	...
	handlers "github.com/Azure/radius/pkg/radrp/handlers"
...
func (m *MockResourceHandler) Delete(arg0 context.Context, arg1 handlers.DeleteOptions) error {
	m.ctrl.T.Helper()
...
func (m *MockResourceHandler) Put(arg0 context.Context, arg1 *handlers.PutOptions) (map[string]string, error) {
	m.ctrl.T.Helper()
