...
> [!NOTE]
>
> **Internal**: Google Cloud support is not a MVP feature. See the fast-follow list in Q25.
...
> [!NOTE]
>
> **Internal**: ECS, ACA, and Cloud Run are not MVP features. See the fast-follow list in Q25.
...
> [!NOTE]
>
> **Internal**: Drift detection is not a MVP feature. See the fast-follow list in Q25.
...
> [!NOTE]
>
> **Internal**: Export to Bicep is not a MVP feature. See the fast-follow list in Q25.
...
**Q22: How does GitHub Radius relate to Repo Radius?**
...
**Q23: Why are application definitions no longer in Bicep? Doesn't that go against our objective with Radius?**
...
**Q24: What new features does GitHub Radius introduce over the Kubernetes-based version?**
...
**Q25: Once GitHub Radius launches, what are the fast-follow features?**
...
**Q26: What about the existing resource types and recipes in the `resource-types-contrib` repo?**
...
**Q27: How does the developer know Radius is involved?**
...
**Q28: What is the relationship between GitHub Radius and the Kubernetes-based version going forward?** 
...
**Q29: What new GitHub Radius features will be implemented in Kubernetes-based Radius?**
...
**Q30: What new GitHub Radius features are not generalizable but could be implemented in Kubernetes-based Radius?**
