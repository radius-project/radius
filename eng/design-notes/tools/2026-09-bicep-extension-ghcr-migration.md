...
| Repository                       | Cleanup                                                                                                                                                                                                                                                                                                                                                                                                             |
|----------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `radius-project/radius`          | Retarget the Bicep publisher dispatch and monitoring in `.github/workflows/build.yaml` to `radius-project/bicep-publisher`; remove the `azure-octo/radius-publisher` path after dual publishing; remove the `biceptypes` cleanup job from `.github/workflows/purge-azure-test-resources.yaml`; remove active ACR references from CLI scaffolding, generated configs, CI, tests, contributor docs, and agent assets. |
| `radius-project/bicep-types-aws` | Retarget `.github/workflows/publish-bicep.yaml` to `radius-project/bicep-publisher`; remove the `azure-octo/radius-publisher` path after dual publishing.                                                                                                                                                                                                                                                           |
