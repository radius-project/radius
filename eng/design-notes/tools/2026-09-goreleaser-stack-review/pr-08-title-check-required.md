...
- actionlint and Prettier pass for the workflow; the changelog configuration test passes; shfmt and ShellCheck are clean; markdownlint passes for the contributing guide and these notes.
