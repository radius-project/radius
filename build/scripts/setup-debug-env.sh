...
main() {
    ...
    echo ""
    log_info "Next steps:"
    echo "1. Run 'make debug-vscode' to generate VS Code configuration"
    echo "2. Run 'make debug-start' to start all components"
    echo "3. Run 'make debug-env-init' to create resources and register recipes"
    echo ""
    log_info "Alternative manual steps:"
    echo "3a. Run './rad group create default && ./rad env create default' to create resources"
    echo "3b. Run 'make debug-register-recipes' to register default recipes"
    echo ""
