...
publish-test-recipes: ## Publishes test recipes to <RECIPE_REGISTRY> with version <RECIPE_TAG_VERSION>
	...
	@echo "$(ARROW) Publishing recipes from ./test/functional/shared/resources/testdata/recipes/test-recipes..."
	./.github/scripts/publish-recipes.sh \
		${RAD_BICEP_PATH} \
		./test/functional/shared/resources/testdata/recipes/test-recipes \
