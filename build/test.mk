...
.PHONY: test
test: test-get-envtools test-helm test-manage-radius-installation test-update-tools-pr test-run-rad-commands-action test-build-platforms test-publish-deploy-status test-verify-azure ## Runs unit tests, excluding kubernetes controller tests
