...
.PHONY: test
test: test-get-envtools test-helm test-manage-radius-installation test-release-parity-manifest test-verify-goreleaser-snapshot ## Runs unit tests, excluding kubernetes controller tests
