...
.PHONY: test
test: test-get-envtools test-helm test-manage-radius-installation test-update-tools-pr test-run-rad-commands-action test-publish-deploy-status ## Runs unit tests, excluding kubernetes controller tests
