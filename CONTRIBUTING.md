...
- Before writing code, comment on the issue and wait for a maintainer to confirm that you may work on it. Creating an issue, assignment to someone else, or a label other than the required labels is not authorization to open an automated pull request.
