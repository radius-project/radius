...
//go:generate mockgen -destination=./mock_resourceclient.go -package=processors -self_package github.com/project-radius/radius/pkg/portableresources/processors github.com/project-radius/radius/pkg/portableresources/processors ResourceClient
