...
import (
	...
	"github.com/project-radius/radius/pkg/portableresources/frontend/handler"
)
...
// Name returns the namespace of the portable resource provider.
func (s *Service) Name() string {
	return handler.PortableResourcesNamespace
}
