...
// Source: github.com/project-radius/radius/pkg/deployment (interfaces: DeploymentProcessor)
...
func (m *MockDeploymentProcessor) Deploy(arg0 context.Context, arg1 resources.ID, arg2 rp.RendererOutput) (rp.DeploymentOutput, error) {
	m.ctrl.T.Helper()
...
func (m *MockDeploymentProcessor) FetchSecrets(arg0 context.Context, arg1 rp.ResourceData) (map[string]interface{}, error) {
	m.ctrl.T.Helper()
...
func (m *MockDeploymentProcessor) Render(arg0 context.Context, arg1 resources.ID, arg2 conv.DataModelInterface) (rp.RendererOutput, error) {
	m.ctrl.T.Helper()
