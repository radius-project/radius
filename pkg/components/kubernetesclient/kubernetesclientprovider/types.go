...
// FromEmpty creates a new Kubernetes client provider with an empty config.
//
// This is useful for testing. Use the Set* methods to set the clients.
func FromEmpty() *KubernetesClientProvider {
	return &KubernetesClientProvider{}
}
