...
func (e *KubernetesEnvironment) CreateDiagnosticsClient(ctx context.Context) (clients.DiagnosticsClient, error) {
	...
	_, con, err := kubernetes.CreateAPIServerConnection(e.Context, e.APIServerBaseURL, e.EnableUCP, e.Namespace)
	if err != nil {
		return nil, err
	}
...
func (e *KubernetesEnvironment) CreateManagementClient(ctx context.Context) (clients.ManagementClient, error) {
	_, connection, err := kubernetes.CreateAPIServerConnection(e.Context, e.APIServerBaseURL, e.EnableUCP, e.Namespace)
	if err != nil {
		return nil, err
	}
