...
// ReadARMJSON reads a JSON file from the given file path and returns a map of strings to any type,
// or an error if the file could not be read or unmarshalled.
