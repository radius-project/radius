...
//	This function is used to stream logs from a Kubernetes cluster. It takes in a context and options as parameters and uses
//	 the Stern library to watch pods based on a set of filters. It then pipes all of the matching logstreams to the writer. 
//	It also uses the "radius.dev/application" label to include pods that are part of an application. Finally, it blocks 
...
//
// <AiDoc: The following comments were generated by OpenAI explaining the code as it existed at the time of this commit>
//	The function is creating a map that contains a function that takes a color and a string as parameters and returns a 
//	string. The function uses the provided color to add ASCII escapes to the string.
//
// </AiDoc: End of OpenAI comments>
