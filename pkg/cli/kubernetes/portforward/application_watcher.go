...
//	This function creates a new applicationWatcher object with the given options. It also creates a done channel and a map 
//	of deploymentWatchers.
//
...
//
// <AiDoc: The following comments were generated by OpenAI explaining the code as it existed at the time of this commit>
//	This function is watching for changes to deployments in a Kubernetes cluster that are labeled with a specific 
//	application name. When a change is detected, the function will either update or delete the deployment depending on the 
...
//
// <AiDoc: The following comments were generated by OpenAI explaining the code as it existed at the time of this commit>
//	The previous function is checking if a deployment has been updated. If the deployment has been updated, but still 
//	targets the same pods, then nothing is done. If the deployment has changed its match labels, then the watcher is shut 
//	down and restarted. If the deployment is new, then a new watcher is created. The watcher will run until it is canceled 
...
//
// <AiDoc: The following comments were generated by OpenAI explaining the code as it existed at the time of this commit>
//	This function is checking if a deployment with a given name exists in the application watcher's deployment watchers map.
//	 If it does, it cancels the entry and waits for it to finish before deleting it from the map.
//
// </AiDoc: End of OpenAI comments>
...
//
// <AiDoc: The following comments were generated by OpenAI explaining the code as it existed at the time of this commit>
//	The function is used to wait for a signal that indicates that the application watcher is done. When the signal is 
//	received, the function will end.
//
// </AiDoc: End of OpenAI comments>
