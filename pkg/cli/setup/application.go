...
//	This function is creating a directory called ".rad" in the specified directory, creating a file called "app.bicep" in 
//	the specified directory, and creating a file called "rad.yaml" in the ".rad" directory. It is also writing content to 
//	the "app.bicep" and "rad.yaml" files.
//
