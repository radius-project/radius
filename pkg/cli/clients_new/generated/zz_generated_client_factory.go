...
func NewClientFactory(rootScope string, resourceType string, credential azcore.TokenCredential, options *arm.ClientOptions) (*ClientFactory, error) {
	...
	return &ClientFactory{
		rootScope: 	rootScope,		resourceType: 	resourceType,		credential: credential,
		options: options.Clone(),
	}, nil
}

func (c *ClientFactory) NewGenericResourcesClient() *GenericResourcesClient {
	subClient, _ := NewGenericResourcesClient(c.rootScope, c.resourceType, c.credential, c.options)
	return subClient
}
