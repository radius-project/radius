...
func (m *MockCredentialManagementClient) PutAWS(arg0 context.Context, arg1 v20230415preview.AWSCredentialResource) error {
	m.ctrl.T.Helper()
...
func (m *MockCredentialManagementClient) PutAzure(arg0 context.Context, arg1 v20230415preview.AzureCredentialResource) error {
	m.ctrl.T.Helper()
