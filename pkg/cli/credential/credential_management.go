...
//	The function is checking the type of credential that is being passed in and then creating the credential in the 
//	appropriate cloud provider. If the type of credential is not supported, an error is returned.
//
...
//	This function is used to get the credentials for a given cloud provider. It takes in a context and a provider name as 
//	parameters. Depending on the provider name, it will call the GetCredential function from the CredentialInterface with 
//	the appropriate plane type and plane name. If the credential for the provider plane is not registered, it will return a 
//	404 error. If there is an error, it will return an error. Otherwise, it will return the credentials.
//
// </AiDoc: End of OpenAI comments>
...
//
// <AiDoc: The following comments were generated by OpenAI explaining the code as it existed at the time of this commit>
//	This function is used to list the credentials for both Azure and AWS. It first retrieves the credentials for Azure and 
//	then retrieves the credentials for AWS. The results from both are then combined and returned.
//
// </AiDoc: End of OpenAI comments>
...
//
// <AiDoc: The following comments were generated by OpenAI explaining the code as it existed at the time of this commit>
//	This function is used to delete a credential from the UCPCredentialManagementClient. It takes in a context and a 
//	provider name as parameters. Depending on the provider name, it will delete the credential from either the AzurePlane or
//	 the AWSPlane. If the credential is not found, it will return true and no error. If an error occurs, it will return 
//	false and the error.
//
// </AiDoc: End of OpenAI comments>
