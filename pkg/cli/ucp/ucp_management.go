...
func (amc *ARMApplicationsManagementClient) CreateEnvironment(ctx context.Context, envName string, location string, namespace string, envKind string, resourceId string, recipeProperties map[string]*corerp.EnvironmentRecipeProperties, providers *corerp.Providers, useRadiusOwnedRecipes bool) (bool, error) {
	...
	properties := corerp.EnvironmentProperties{Compute: &envCompute, Recipes: recipeProperties, UseRadiusOwnedRecipes: &useRadiusOwnedRecipes}
