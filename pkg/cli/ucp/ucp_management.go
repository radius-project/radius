...
func (amc *ARMApplicationsManagementClient) ShowRecipe(ctx context.Context, recipeName string, environmentName string) (corerp.EnvironmentRecipeProperties, error) {
	return corerp.EnvironmentRecipeProperties{}, nil
}
