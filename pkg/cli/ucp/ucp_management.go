...
var (
	ResourceTypesList = []string{
		linkrp.MongoDatabasesResourceTypeName,
		linkrp.RabbitMQMessageQueuesResourceTypeName,
		linkrp.RedisCachesResourceTypeName,
		linkrp.SqlDatabasesResourceTypeName,
		linkrp.DaprStateStoresResourceTypeName,
		linkrp.DaprSecretStoresResourceTypeName,
		linkrp.DaprPubSubBrokersResourceTypeName,
		linkrp.DaprInvokeHttpRoutesResourceTypeName,
		linkrp.ExtendersResourceTypeName,
