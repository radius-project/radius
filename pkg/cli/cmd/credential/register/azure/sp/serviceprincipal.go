...
// NewCommand creates an instance of the command and runner for the `rad credential register azure sp` command.
//

// NewCommand creates a new cobra command for registering an Azure cloud provider service principal credential for a Radius installation,
...
func NewCommand(factory framework.Factory) (*cobra.Command, framework.Runner) {
	...
	cmd := &cobra.Command{
		Use:   "sp",
		Short: "Register (Add or update) Azure cloud provider service principal credential for a Radius installation.",
		Long: `Register (Add or update) Azure cloud provider service principal credential for a Radius installation.
...
// NewRunner creates a new instance of the `rad credential register azure sp` runner.
