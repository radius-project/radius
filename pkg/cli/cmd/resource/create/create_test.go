	...
	testcases := []radcli.ValidateInput{
		{
			...
			Input:         []string{"Applications.Test/exampleResources", "my-example", string(b)},
			ExpectedValid: true,
			ConfigHolder:  framework.ConfigHolder{Config: config},
		},
		{
			Name:                "Valid: JSON file",
			Input:               []string{"Applications.Test/exampleResources", "my-example", "@valid-resource.json"},
			ExpectedValid:       true,
			ConfigHolder:        framework.ConfigHolder{Config: config},
		...
		},
		{
			...
			Input:         []string{"Applications.Test/exampleResources", "my-example", "{askdfe}"},
			ExpectedValid: false,
			ConfigHolder:  framework.ConfigHolder{Config: config},
		},
		{
			Name:                "Invalid: non-JSON file",
			Input:               []string{"Applications.Test/exampleResources", "my-example", "@invalid-resource.json"},
			ExpectedValid:       false,
			ConfigHolder:        framework.ConfigHolder{Config: config},
			CreateTempDirectory: directory,
		},
		...
		},
		{
			...
			Input:         []string{"Applications.Test/exampleResources", "my-example", "@valid-resource.json", "dddddd"},
			ExpectedValid: false,
			ConfigHolder:  framework.ConfigHolder{Config: config},
		},
	}
