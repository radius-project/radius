...
func Test_Run(t *testing.T) {
	resourceProvider := v20231001preview.ResourceProviderResource{
		...
		Properties: &v20231001preview.ResourceProviderProperties{
			ResourceTypes: []*v20231001preview.ResourceType{
				{
					ResourceType: to.Ptr("exampleResources"),
	...
	t.Run("Success: Resource Provider Found", func(t *testing.T) {
		ctrl := gomock.NewController(t)
		defer ctrl.Finish()

		appManagementClient := clients.NewMockApplicationsManagementClient(ctrl)
		appManagementClient.EXPECT().
			GetResourceProvider(gomock.Any(), "local", "Applications.Test").
	...
	t.Run("Error: Resource Provider Not Found", func(t *testing.T) {
		...
		appManagementClient := clients.NewMockApplicationsManagementClient(ctrl)
		appManagementClient.EXPECT().
			GetResourceProvider(gomock.Any(), "local", "Applications.AnotherTest").
			Return(v20231001preview.ResourceProviderResource{}, radcli.Create404Error()).
			Times(1)
