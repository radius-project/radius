...
const (
	deleteConfirmation = "Are you sure you want to delete resource provider %q? This will delete all resource types and resources defined by the resource provider."
)
