...
func Test_Validate(t *testing.T) {
	...
	initMocksWithoutCloudProvider(kubernetesMock, prompter)
	...
	testcases := []radcli.ValidateInput{
		{
			...
			Prompter:            prompter,
			HelmInterface:       &helm.MockHelmInterface{},
		},
		{
...
func initMocksWithoutCloudProvider(kubernetesMock *kubernetes.MockInterface, prompterMock *prompt.MockInterface) {
...
// func initSelectCloudProviderAzure(prompter *prompt.MockInterface) {
// 	prompter.EXPECT().
// 	RunPrompt(gomock.Any()).
// 	Return(0, "", nil).Times(1)
// }

// func initSelectCloudProviderError(prompter *prompt.MockInterface) {
// 	prompter.EXPECT().
// 	RunPrompt(gomock.Any()).
// 	Return(-1, "", errors.New("unable to select cloud provider")).Times(1)
// }

// func initAddAnotherCloudProviderPromptYes(prompter *prompt.MockInterface) {
// 	prompter.EXPECT().
// 	RunPrompt(gomock.Any()).
// 	Return("Y", nil).Times(1)
// }

// func initAddAnotherCloudProviderPromptNo(prompter *prompt.MockInterface) {
// 	prompter.EXPECT().
// 	RunPrompt(gomock.Any()).
// 	Return("N", nil).Times(1)
// }

// func initAddAnotherCloudProviderPromptError(prompter *prompt.MockInterface) {
// 	prompter.EXPECT().
// 		RunPrompt(gomock.Any()).
// 		Return("", errors.New("Unable to read input")).Times(1)
// }
