...
func Test_Validate(t *testing.T) {
	...
	testcases := []radcli.ValidateInput{
		{
			Name:          "Valid",
			Input:         []string{"Applications.Test/testResources"},
			ExpectedValid: true,
		...
		},
		{
			...
			Input:         []string{"Applications.Test/testResources", "dddd"},
			ExpectedValid: false,
			ConfigHolder:  framework.ConfigHolder{Config: config},
		},
		{
...
func Test_Run(t *testing.T) {
	t.Run("Success: Resource Type Deleted", func(t *testing.T) {
		ctrl := gomock.NewController(t)
		defer ctrl.Finish()

		appManagementClient := clients.NewMockApplicationsManagementClient(ctrl)
		appManagementClient.EXPECT().
			DeleteResourceType(gomock.Any(), "local", "Applications.Test", "testResources").
			Return(true, nil).
			Times(1)
		...
		runner := &Runner{
			...
			Format:                    "table",
			Output:                    outputSink,
			ResourceTypeName:          "Applications.Test/testResources",
	...
	t.Run("Success: Resource Type Not Found", func(t *testing.T) {
		ctrl := gomock.NewController(t)
		defer ctrl.Finish()
	...
	t.Run("Success: Prompt Confirmed", func(t *testing.T) {
		...
		promptMock.EXPECT().
			GetListInput([]string{prompt.ConfirmNo, prompt.ConfirmYes}, fmt.Sprintf(deleteConfirmation, "Applications.Test/testResources")).
