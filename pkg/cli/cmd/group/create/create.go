...
func (r *Runner) Run(ctx context.Context) error {
	...
	_, err = client.CreateUCPGroup(ctx, "radius", "local", r.UCPResourceGroupName, v20230415preview.ResourceGroupResource{
	...
	_, err = client.CreateUCPGroup(ctx, "deployments", "local", r.UCPResourceGroupName, v20230415preview.ResourceGroupResource{
		Location: to.Ptr(v1.LocationGlobal),
	})
	if err != nil {
		return err
