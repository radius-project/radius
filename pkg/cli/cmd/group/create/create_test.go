...
func Test_Run(t *testing.T) {
	t.Run("Run rad group create", func(t *testing.T) {
		...
		appManagementClient.EXPECT().CreateOrUpdateResourceGroup(gomock.Any(), "local", "testrg", gomock.Any()).Return(nil).Times(1)
		...
		expected := []any{
			output.LogOutput{
				Format: "System.Resources/resourceGroups/%s created",
				Params: []any{"testrg"},
			},
		}
