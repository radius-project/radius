...
// Source: github.com/project-radius/radius/pkg/cli/cmd/env/create/namespace (interfaces: Interface)
...
func (m *MockInterface) ValidateNamespace(arg0 context.Context, arg1 kubernetes.Interface, arg2 string) error {
	m.ctrl.T.Helper()
