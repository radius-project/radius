...
//
//	mockgen -destination=./mock_cluster.go -package=helm -self_package github.com/radius-project/radius/pkg/cli/helm github.com/radius-project/radius/pkg/cli/helm Interface
//
...
func (mr *MockInterfaceMockRecorder) CheckRadiusInstall(arg0 any) *gomock.Call {
...
func (mr *MockInterfaceMockRecorder) InstallRadius(arg0, arg1, arg2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockInterfaceMockRecorder) UninstallRadius(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
