...
//	This function applies a Helm chart to a Kubernetes cluster in order to install or upgrade the Radius control plane. It 
//	takes in a set of RadiusOptions and a Kubernetes context as parameters. It first checks if the Helm chart is already 
//	installed, and if it is, it will not reinstall it unless the '--reinstall' flag is set. If the chart is not installed, 
//	it will install it. It also adds values to the Helm chart based on the RadiusOptions and the provider type (Azure or 
//	AWS).
//
...
//
// <AiDoc: The following comments were generated by OpenAI explaining the code as it existed at the time of this commit>
//	This function is retrieving the Azure Provider configuration from a Helm release. It is checking if the Helm release 
//	exists, and if it does, it is retrieving the subscription ID and resource group from the configuration. It then creates 
//	an Azure Provider object with the retrieved information and returns it.
//
// </AiDoc: End of OpenAI comments>
...
//
// <AiDoc: The following comments were generated by OpenAI explaining the code as it existed at the time of this commit>
//	This function is setting up a Helm installation for a release called "radiusReleaseName" in a namespace called 
//	"RadiusSystemNamespace". It will create the namespace if it does not already exist, and will wait for the installation 
//	to complete before timing out after a set amount of time. Finally, it will run the Helm installation with the given 
//	chart.
//
// </AiDoc: End of OpenAI comments>
...
//
// <AiDoc: The following comments were generated by OpenAI explaining the code as it existed at the time of this commit>
//	This function is used to upgrade a Helm release with the given name and Helm chart. It sets the namespace to the 
//	RadiusSystemNamespace, sets the timeout to the installTimeout, and sets the recreate flag to true, which will force the 
//	recreation of the radius pods when adding or modifying the azprovider. Finally, it runs the upgrade with the given 
//	release name and Helm chart.
//
// </AiDoc: End of OpenAI comments>
...
//
// <AiDoc: The following comments were generated by OpenAI explaining the code as it existed at the time of this commit>
//	The function is adding values to a Helm Chart for an AWS Provider. It checks if the AWS Provider is not nil, and if it 
//	is not, it adds the Access Key ID, Secret Access Key, and Target Region to the Helm Chart.
//
// </AiDoc: End of OpenAI comments>
...
//
// <AiDoc: The following comments were generated by OpenAI explaining the code as it existed at the time of this commit>
//	This function is uninstalling the Radius system from a given namespace. It sets a timeout for the uninstallation and 
//	waits for the uninstallation to complete before returning. If the Radius system is not found, it will log a message and 
