...
//
//	mockgen -destination=./mock_deploy.go -package=deploy -self_package github.com/radius-project/radius/pkg/cli/deploy github.com/radius-project/radius/pkg/cli/deploy Interface
//
...
func (mr *MockInterfaceMockRecorder) DeployWithProgress(arg0, arg1 any) *gomock.Call {
