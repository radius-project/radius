...
//	This function deploys a template with the given parameters and options. It also displays the progress of the deployment 
//	and the resources created. It also finds and displays any public endpoints created by the deployment.
//
