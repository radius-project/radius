...
type ApplicationsManagementClient interface {
	...
	ShowRecipe(ctx context.Context, environmentResource corerp.EnvironmentResource, recipe *corerp.EnvironmentRecipeProperties, recipeName string) (corerp.EnvironmentRecipeProperties, error)
}
