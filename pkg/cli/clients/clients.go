...
type ApplicationsManagementClient interface {
	...
	CreateEnvironment(ctx context.Context, envName, location, namespace, envKind, resourceId string, recipeProperties map[string]*corerp.EnvironmentRecipeProperties) (bool, error)
	...
	CheckUCPGroupExistence(ctx context.Context, planeType string, planeName string, rgName string) (bool, error)
}
