...
// Source: github.com/project-radius/radius/pkg/cli/clients (interfaces: CredentialManagementClient)
...
func (m *MockCredentialManagementClient) Get(arg0 context.Context, arg1 string) (credential.ProviderCredentialResource, error) {
	m.ctrl.T.Helper()
...
func (m *MockCredentialManagementClient) List(arg0 context.Context) ([]credential.ProviderCredentialResource, error) {
	m.ctrl.T.Helper()
...
func (m *MockCredentialManagementClient) Put(arg0 context.Context, arg1 credential.ProviderCredentialConfiguration) error {
	m.ctrl.T.Helper()
