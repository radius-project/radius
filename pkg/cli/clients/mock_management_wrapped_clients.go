...
// MockrecipePackResourceClient is a mock of recipePackResourceClient interface.
...
type MockrecipePackResourceClientMockRecorder struct {
	mock *MockrecipePackResourceClient
}

// NewMockrecipePackResourceClient creates a new mock instance.
func NewMockrecipePackResourceClient(ctrl *gomock.Controller) *MockrecipePackResourceClient {
	mock := &MockrecipePackResourceClient{ctrl: ctrl}
	mock.recorder = &MockrecipePackResourceClientMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockrecipePackResourceClient) EXPECT() *MockrecipePackResourceClientMockRecorder {
	return m.recorder
}

// CreateOrUpdate mocks base method.
func (m *MockrecipePackResourceClient) CreateOrUpdate(ctx context.Context, recipePackName string, resource v20250801preview.RecipePackResource, options *v20250801preview.RecipePacksClientCreateOrUpdateOptions) (v20250801preview.RecipePacksClientCreateOrUpdateResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateOrUpdate", ctx, recipePackName, resource, options)
	ret0, _ := ret[0].(v20250801preview.RecipePacksClientCreateOrUpdateResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreateOrUpdate indicates an expected call of CreateOrUpdate.
func (mr *MockrecipePackResourceClientMockRecorder) CreateOrUpdate(ctx, recipePackName, resource, options any) *MockrecipePackResourceClientCreateOrUpdateCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateOrUpdate", reflect.TypeOf((*MockrecipePackResourceClient)(nil).CreateOrUpdate), ctx, recipePackName, resource, options)
	return &MockrecipePackResourceClientCreateOrUpdateCall{Call: call}
}

// MockrecipePackResourceClientCreateOrUpdateCall wrap *gomock.Call
type MockrecipePackResourceClientCreateOrUpdateCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockrecipePackResourceClientCreateOrUpdateCall) Return(arg0 v20250801preview.RecipePacksClientCreateOrUpdateResponse, arg1 error) *MockrecipePackResourceClientCreateOrUpdateCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockrecipePackResourceClientCreateOrUpdateCall) Do(f func(context.Context, string, v20250801preview.RecipePackResource, *v20250801preview.RecipePacksClientCreateOrUpdateOptions) (v20250801preview.RecipePacksClientCreateOrUpdateResponse, error)) *MockrecipePackResourceClientCreateOrUpdateCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockrecipePackResourceClientCreateOrUpdateCall) DoAndReturn(f func(context.Context, string, v20250801preview.RecipePackResource, *v20250801preview.RecipePacksClientCreateOrUpdateOptions) (v20250801preview.RecipePacksClientCreateOrUpdateResponse, error)) *MockrecipePackResourceClientCreateOrUpdateCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// Delete mocks base method.
func (m *MockrecipePackResourceClient) Delete(ctx context.Context, recipePackName string, options *v20250801preview.RecipePacksClientDeleteOptions) (v20250801preview.RecipePacksClientDeleteResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Delete", ctx, recipePackName, options)
	ret0, _ := ret[0].(v20250801preview.RecipePacksClientDeleteResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// Delete indicates an expected call of Delete.
func (mr *MockrecipePackResourceClientMockRecorder) Delete(ctx, recipePackName, options any) *MockrecipePackResourceClientDeleteCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockrecipePackResourceClient)(nil).Delete), ctx, recipePackName, options)
	return &MockrecipePackResourceClientDeleteCall{Call: call}
}

// MockrecipePackResourceClientDeleteCall wrap *gomock.Call
type MockrecipePackResourceClientDeleteCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockrecipePackResourceClientDeleteCall) Return(arg0 v20250801preview.RecipePacksClientDeleteResponse, arg1 error) *MockrecipePackResourceClientDeleteCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockrecipePackResourceClientDeleteCall) Do(f func(context.Context, string, *v20250801preview.RecipePacksClientDeleteOptions) (v20250801preview.RecipePacksClientDeleteResponse, error)) *MockrecipePackResourceClientDeleteCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockrecipePackResourceClientDeleteCall) DoAndReturn(f func(context.Context, string, *v20250801preview.RecipePacksClientDeleteOptions) (v20250801preview.RecipePacksClientDeleteResponse, error)) *MockrecipePackResourceClientDeleteCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// Get mocks base method.
func (m *MockrecipePackResourceClient) Get(ctx context.Context, recipePackName string, options *v20250801preview.RecipePacksClientGetOptions) (v20250801preview.RecipePacksClientGetResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", ctx, recipePackName, options)
	ret0, _ := ret[0].(v20250801preview.RecipePacksClientGetResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// Get indicates an expected call of Get.
func (mr *MockrecipePackResourceClientMockRecorder) Get(ctx, recipePackName, options any) *MockrecipePackResourceClientGetCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockrecipePackResourceClient)(nil).Get), ctx, recipePackName, options)
	return &MockrecipePackResourceClientGetCall{Call: call}
}

// MockrecipePackResourceClientGetCall wrap *gomock.Call
type MockrecipePackResourceClientGetCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockrecipePackResourceClientGetCall) Return(arg0 v20250801preview.RecipePacksClientGetResponse, arg1 error) *MockrecipePackResourceClientGetCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockrecipePackResourceClientGetCall) Do(f func(context.Context, string, *v20250801preview.RecipePacksClientGetOptions) (v20250801preview.RecipePacksClientGetResponse, error)) *MockrecipePackResourceClientGetCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockrecipePackResourceClientGetCall) DoAndReturn(f func(context.Context, string, *v20250801preview.RecipePacksClientGetOptions) (v20250801preview.RecipePacksClientGetResponse, error)) *MockrecipePackResourceClientGetCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// NewListByScopePager mocks base method.
func (m *MockrecipePackResourceClient) NewListByScopePager(options *v20250801preview.RecipePacksClientListByScopeOptions) *runtime.Pager[v20250801preview.RecipePacksClientListByScopeResponse] {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewListByScopePager", options)
	ret0, _ := ret[0].(*runtime.Pager[v20250801preview.RecipePacksClientListByScopeResponse])
	return ret0
}

// NewListByScopePager indicates an expected call of NewListByScopePager.
func (mr *MockrecipePackResourceClientMockRecorder) NewListByScopePager(options any) *MockrecipePackResourceClientNewListByScopePagerCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewListByScopePager", reflect.TypeOf((*MockrecipePackResourceClient)(nil).NewListByScopePager), options)
	return &MockrecipePackResourceClientNewListByScopePagerCall{Call: call}
}

// MockrecipePackResourceClientNewListByScopePagerCall wrap *gomock.Call
type MockrecipePackResourceClientNewListByScopePagerCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockrecipePackResourceClientNewListByScopePagerCall) Return(arg0 *runtime.Pager[v20250801preview.RecipePacksClientListByScopeResponse]) *MockrecipePackResourceClientNewListByScopePagerCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockrecipePackResourceClientNewListByScopePagerCall) Do(f func(*v20250801preview.RecipePacksClientListByScopeOptions) *runtime.Pager[v20250801preview.RecipePacksClientListByScopeResponse]) *MockrecipePackResourceClientNewListByScopePagerCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockrecipePackResourceClientNewListByScopePagerCall) DoAndReturn(f func(*v20250801preview.RecipePacksClientListByScopeOptions) *runtime.Pager[v20250801preview.RecipePacksClientListByScopeResponse]) *MockrecipePackResourceClientNewListByScopePagerCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// MockradiusCoreEnvironmentResourceClient is a mock of radiusCoreEnvironmentResourceClient interface.
...
type MockradiusCoreEnvironmentResourceClientMockRecorder struct {
	mock *MockradiusCoreEnvironmentResourceClient
}

// NewMockradiusCoreEnvironmentResourceClient creates a new mock instance.
func NewMockradiusCoreEnvironmentResourceClient(ctrl *gomock.Controller) *MockradiusCoreEnvironmentResourceClient {
	mock := &MockradiusCoreEnvironmentResourceClient{ctrl: ctrl}
	mock.recorder = &MockradiusCoreEnvironmentResourceClientMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockradiusCoreEnvironmentResourceClient) EXPECT() *MockradiusCoreEnvironmentResourceClientMockRecorder {
	return m.recorder
}

// CreateOrUpdate mocks base method.
func (m *MockradiusCoreEnvironmentResourceClient) CreateOrUpdate(ctx context.Context, environmentName string, resource v20250801preview.EnvironmentResource, options *v20250801preview.EnvironmentsClientCreateOrUpdateOptions) (v20250801preview.EnvironmentsClientCreateOrUpdateResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateOrUpdate", ctx, environmentName, resource, options)
	ret0, _ := ret[0].(v20250801preview.EnvironmentsClientCreateOrUpdateResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreateOrUpdate indicates an expected call of CreateOrUpdate.
func (mr *MockradiusCoreEnvironmentResourceClientMockRecorder) CreateOrUpdate(ctx, environmentName, resource, options any) *MockradiusCoreEnvironmentResourceClientCreateOrUpdateCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateOrUpdate", reflect.TypeOf((*MockradiusCoreEnvironmentResourceClient)(nil).CreateOrUpdate), ctx, environmentName, resource, options)
	return &MockradiusCoreEnvironmentResourceClientCreateOrUpdateCall{Call: call}
}

// MockradiusCoreEnvironmentResourceClientCreateOrUpdateCall wrap *gomock.Call
type MockradiusCoreEnvironmentResourceClientCreateOrUpdateCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockradiusCoreEnvironmentResourceClientCreateOrUpdateCall) Return(arg0 v20250801preview.EnvironmentsClientCreateOrUpdateResponse, arg1 error) *MockradiusCoreEnvironmentResourceClientCreateOrUpdateCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockradiusCoreEnvironmentResourceClientCreateOrUpdateCall) Do(f func(context.Context, string, v20250801preview.EnvironmentResource, *v20250801preview.EnvironmentsClientCreateOrUpdateOptions) (v20250801preview.EnvironmentsClientCreateOrUpdateResponse, error)) *MockradiusCoreEnvironmentResourceClientCreateOrUpdateCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockradiusCoreEnvironmentResourceClientCreateOrUpdateCall) DoAndReturn(f func(context.Context, string, v20250801preview.EnvironmentResource, *v20250801preview.EnvironmentsClientCreateOrUpdateOptions) (v20250801preview.EnvironmentsClientCreateOrUpdateResponse, error)) *MockradiusCoreEnvironmentResourceClientCreateOrUpdateCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// Delete mocks base method.
func (m *MockradiusCoreEnvironmentResourceClient) Delete(ctx context.Context, environmentName string, options *v20250801preview.EnvironmentsClientDeleteOptions) (v20250801preview.EnvironmentsClientDeleteResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Delete", ctx, environmentName, options)
	ret0, _ := ret[0].(v20250801preview.EnvironmentsClientDeleteResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// Delete indicates an expected call of Delete.
func (mr *MockradiusCoreEnvironmentResourceClientMockRecorder) Delete(ctx, environmentName, options any) *MockradiusCoreEnvironmentResourceClientDeleteCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Delete", reflect.TypeOf((*MockradiusCoreEnvironmentResourceClient)(nil).Delete), ctx, environmentName, options)
	return &MockradiusCoreEnvironmentResourceClientDeleteCall{Call: call}
}

// MockradiusCoreEnvironmentResourceClientDeleteCall wrap *gomock.Call
type MockradiusCoreEnvironmentResourceClientDeleteCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockradiusCoreEnvironmentResourceClientDeleteCall) Return(arg0 v20250801preview.EnvironmentsClientDeleteResponse, arg1 error) *MockradiusCoreEnvironmentResourceClientDeleteCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockradiusCoreEnvironmentResourceClientDeleteCall) Do(f func(context.Context, string, *v20250801preview.EnvironmentsClientDeleteOptions) (v20250801preview.EnvironmentsClientDeleteResponse, error)) *MockradiusCoreEnvironmentResourceClientDeleteCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockradiusCoreEnvironmentResourceClientDeleteCall) DoAndReturn(f func(context.Context, string, *v20250801preview.EnvironmentsClientDeleteOptions) (v20250801preview.EnvironmentsClientDeleteResponse, error)) *MockradiusCoreEnvironmentResourceClientDeleteCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// Get mocks base method.
func (m *MockradiusCoreEnvironmentResourceClient) Get(ctx context.Context, environmentName string, options *v20250801preview.EnvironmentsClientGetOptions) (v20250801preview.EnvironmentsClientGetResponse, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Get", ctx, environmentName, options)
	ret0, _ := ret[0].(v20250801preview.EnvironmentsClientGetResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// Get indicates an expected call of Get.
func (mr *MockradiusCoreEnvironmentResourceClientMockRecorder) Get(ctx, environmentName, options any) *MockradiusCoreEnvironmentResourceClientGetCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockradiusCoreEnvironmentResourceClient)(nil).Get), ctx, environmentName, options)
	return &MockradiusCoreEnvironmentResourceClientGetCall{Call: call}
}

// MockradiusCoreEnvironmentResourceClientGetCall wrap *gomock.Call
type MockradiusCoreEnvironmentResourceClientGetCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockradiusCoreEnvironmentResourceClientGetCall) Return(arg0 v20250801preview.EnvironmentsClientGetResponse, arg1 error) *MockradiusCoreEnvironmentResourceClientGetCall {
	c.Call = c.Call.Return(arg0, arg1)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockradiusCoreEnvironmentResourceClientGetCall) Do(f func(context.Context, string, *v20250801preview.EnvironmentsClientGetOptions) (v20250801preview.EnvironmentsClientGetResponse, error)) *MockradiusCoreEnvironmentResourceClientGetCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockradiusCoreEnvironmentResourceClientGetCall) DoAndReturn(f func(context.Context, string, *v20250801preview.EnvironmentsClientGetOptions) (v20250801preview.EnvironmentsClientGetResponse, error)) *MockradiusCoreEnvironmentResourceClientGetCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}

// NewListByScopePager mocks base method.
func (m *MockradiusCoreEnvironmentResourceClient) NewListByScopePager(options *v20250801preview.EnvironmentsClientListByScopeOptions) *runtime.Pager[v20250801preview.EnvironmentsClientListByScopeResponse] {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "NewListByScopePager", options)
	ret0, _ := ret[0].(*runtime.Pager[v20250801preview.EnvironmentsClientListByScopeResponse])
	return ret0
}

// NewListByScopePager indicates an expected call of NewListByScopePager.
func (mr *MockradiusCoreEnvironmentResourceClientMockRecorder) NewListByScopePager(options any) *MockradiusCoreEnvironmentResourceClientNewListByScopePagerCall {
	mr.mock.ctrl.T.Helper()
	call := mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "NewListByScopePager", reflect.TypeOf((*MockradiusCoreEnvironmentResourceClient)(nil).NewListByScopePager), options)
	return &MockradiusCoreEnvironmentResourceClientNewListByScopePagerCall{Call: call}
}

// MockradiusCoreEnvironmentResourceClientNewListByScopePagerCall wrap *gomock.Call
type MockradiusCoreEnvironmentResourceClientNewListByScopePagerCall struct {
	*gomock.Call
}

// Return rewrite *gomock.Call.Return
func (c *MockradiusCoreEnvironmentResourceClientNewListByScopePagerCall) Return(arg0 *runtime.Pager[v20250801preview.EnvironmentsClientListByScopeResponse]) *MockradiusCoreEnvironmentResourceClientNewListByScopePagerCall {
	c.Call = c.Call.Return(arg0)
	return c
}

// Do rewrite *gomock.Call.Do
func (c *MockradiusCoreEnvironmentResourceClientNewListByScopePagerCall) Do(f func(*v20250801preview.EnvironmentsClientListByScopeOptions) *runtime.Pager[v20250801preview.EnvironmentsClientListByScopeResponse]) *MockradiusCoreEnvironmentResourceClientNewListByScopePagerCall {
	c.Call = c.Call.Do(f)
	return c
}

// DoAndReturn rewrite *gomock.Call.DoAndReturn
func (c *MockradiusCoreEnvironmentResourceClientNewListByScopePagerCall) DoAndReturn(f func(*v20250801preview.EnvironmentsClientListByScopeOptions) *runtime.Pager[v20250801preview.EnvironmentsClientListByScopeResponse]) *MockradiusCoreEnvironmentResourceClientNewListByScopePagerCall {
	c.Call = c.Call.DoAndReturn(f)
	return c
}
