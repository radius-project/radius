...
import (
	...
	v20230415preview0 "github.com/project-radius/radius/pkg/ucp/api/v20230415preview"
)
...
func (m *MockApplicationsManagementClient) CreateApplicationIfNotFound(arg0 context.Context, arg1 string, arg2 v20230415preview.ApplicationResource) error {
	m.ctrl.T.Helper()
...
func (m *MockApplicationsManagementClient) CreateEnvironment(arg0 context.Context, arg1, arg2 string, arg3 *v20230415preview.EnvironmentProperties) (bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockApplicationsManagementClient) CreateOrUpdateApplication(arg0 context.Context, arg1 string, arg2 v20230415preview.ApplicationResource) error {
	m.ctrl.T.Helper()
...
func (m *MockApplicationsManagementClient) CreateUCPGroup(arg0 context.Context, arg1, arg2, arg3 string, arg4 v20230415preview0.ResourceGroupResource) (bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockApplicationsManagementClient) GetEnvDetails(arg0 context.Context, arg1 string) (v20230415preview.EnvironmentResource, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetEnvDetails", arg0, arg1)
	ret0, _ := ret[0].(v20230415preview.EnvironmentResource)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockApplicationsManagementClient) ListApplications(arg0 context.Context) ([]v20230415preview.ApplicationResource, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListApplications", arg0)
	ret0, _ := ret[0].([]v20230415preview.ApplicationResource)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockApplicationsManagementClient) ListEnvironmentsAll(arg0 context.Context) ([]v20230415preview.EnvironmentResource, error) {
	m.ctrl.T.Helper()
...
func (m *MockApplicationsManagementClient) ListEnvironmentsInResourceGroup(arg0 context.Context) ([]v20230415preview.EnvironmentResource, error) {
	m.ctrl.T.Helper()
...
func (m *MockApplicationsManagementClient) ListUCPGroup(arg0 context.Context, arg1, arg2 string) ([]v20230415preview0.ResourceGroupResource, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListUCPGroup", arg0, arg1, arg2)
	ret0, _ := ret[0].([]v20230415preview0.ResourceGroupResource)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockApplicationsManagementClient) ShowApplication(arg0 context.Context, arg1 string) (v20230415preview.ApplicationResource, error) {
	m.ctrl.T.Helper()
...
func (m *MockApplicationsManagementClient) ShowRecipe(arg0 context.Context, arg1, arg2 string) (v20230415preview.EnvironmentRecipeProperties, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ShowRecipe", arg0, arg1, arg2)
	ret0, _ := ret[0].(v20230415preview.EnvironmentRecipeProperties)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockApplicationsManagementClient) ShowUCPGroup(arg0 context.Context, arg1, arg2, arg3 string) (v20230415preview0.ResourceGroupResource, error) {
	m.ctrl.T.Helper()
