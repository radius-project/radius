...
func (m *MockApplicationsManagementClient) ShowRecipe(arg0 context.Context, arg1 string, arg2 v20220315privatepreview.RecipeNameAndLinkType) (v20220315privatepreview.EnvironmentRecipeProperties, error) {
	m.ctrl.T.Helper()
