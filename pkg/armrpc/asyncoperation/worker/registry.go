...
type ControllerFactoryFunc func(store.StorageClient, hostoptions.HostOptions) (ctrl.Controller, error)
...
func (h *ControllerRegistry) Register(ctx context.Context, resourceType string, method v1.OperationMethod, options hostoptions.HostOptions, factoryFn ControllerFactoryFunc) error {
	h.ctrlMapMu.Lock()
