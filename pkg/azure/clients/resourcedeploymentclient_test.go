...
func TestResourceClientPrepare(t *testing.T) {
	...
	request, err := resourceClient.ResourceCreateOrUpdatePreparer(context.TODO(), "/resourcegroups/my-rg/providers/Microsoft.Resources/deployments/my-deployment", Deployment{})
