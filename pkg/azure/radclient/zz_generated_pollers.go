...
// DaprIoSecretStoreCreateOrUpdatePoller provides polling facilities until the operation reaches a terminal state.
type DaprIoSecretStoreCreateOrUpdatePoller struct {
	pt *azcore.Poller
}

// Done returns true if the LRO has reached a terminal state.
func (p *DaprIoSecretStoreCreateOrUpdatePoller) Done() bool {
	return p.pt.Done()
}
...
// Calling Poll on an LRO that has reached a terminal state will return the final
// HTTP response or error.
func (p *DaprIoSecretStoreCreateOrUpdatePoller) Poll(ctx context.Context) (*http.Response, error) {
	return p.pt.Poll(ctx)
}

	// FinalResponse performs a final GET to the service and returns the final response
	// for the polling operation. If there is an error performing the final GET then an error is returned.
	// If the final GET succeeded then the final DaprIoSecretStoreCreateOrUpdateResponse will be returned.
func (p *DaprIoSecretStoreCreateOrUpdatePoller) FinalResponse(ctx context.Context) (DaprIoSecretStoreCreateOrUpdateResponse, error) {
	respType := DaprIoSecretStoreCreateOrUpdateResponse{}
	resp, err := p.pt.FinalResponse(ctx, &respType.DaprSecretStoreResource)
	if err != nil {
		return DaprIoSecretStoreCreateOrUpdateResponse{}, err
	}
	respType.RawResponse = resp
	return respType, nil
}
...
// ResumeToken returns a value representing the poller that can be used to resume
// the LRO at a later time. ResumeTokens are unique per service operation.
func (p *DaprIoSecretStoreCreateOrUpdatePoller) ResumeToken() (string, error) {
	return p.pt.ResumeToken()
}

// DaprIoSecretStoreDeletePoller provides polling facilities until the operation reaches a terminal state.
type DaprIoSecretStoreDeletePoller struct {
	pt *azcore.Poller
}

// Done returns true if the LRO has reached a terminal state.
func (p *DaprIoSecretStoreDeletePoller) Done() bool {
	return p.pt.Done()
}
...
// Calling Poll on an LRO that has reached a terminal state will return the final
// HTTP response or error.
func (p *DaprIoSecretStoreDeletePoller) Poll(ctx context.Context) (*http.Response, error) {
	return p.pt.Poll(ctx)
}

	// FinalResponse performs a final GET to the service and returns the final response
	// for the polling operation. If there is an error performing the final GET then an error is returned.
	// If the final GET succeeded then the final DaprIoSecretStoreDeleteResponse will be returned.
func (p *DaprIoSecretStoreDeletePoller) FinalResponse(ctx context.Context) (DaprIoSecretStoreDeleteResponse, error) {
	respType := DaprIoSecretStoreDeleteResponse{}
	resp, err := p.pt.FinalResponse(ctx, nil)
	if err != nil {
		return DaprIoSecretStoreDeleteResponse{}, err
	}
	respType.RawResponse = resp
	return respType, nil
}
...
// ResumeToken returns a value representing the poller that can be used to resume
// the LRO at a later time. ResumeTokens are unique per service operation.
func (p *DaprIoSecretStoreDeletePoller) ResumeToken() (string, error) {
	return p.pt.ResumeToken()
}
