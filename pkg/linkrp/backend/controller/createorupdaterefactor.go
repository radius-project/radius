...
var _ ctrl.Controller = (*CreateOrUpdateRefactor)(nil)

// CreateOrUpdateRefactor is the async operation controller to create or update Applications.Link resources.
type CreateOrUpdateRefactor struct {
	ctrl.BaseController
	engine recipes.Engine
	auth   *armauth.ArmConfig
}

// NewCreateOrUpdateRefactor creates the CreateOrUpdateResource controller instance.
func NewCreateOrUpdateRefactor(opts ctrl.Options, engine recipes.Engine, auth *armauth.ArmConfig) (ctrl.Controller, error) {
	return &CreateOrUpdateRefactor{
...
func (c *CreateOrUpdateRefactor) Run(ctx context.Context, req *ctrl.Request) (ctrl.Result, error) {
