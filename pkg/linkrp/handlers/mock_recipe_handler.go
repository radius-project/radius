...
import (
	...
	linkrp "github.com/project-radius/radius/pkg/linkrp"
)
...
func (m *MockRecipeHandler) DeployRecipe(arg0 context.Context, arg1 linkrp.RecipeProperties, arg2 datamodel.Providers) ([]string, error) {
	m.ctrl.T.Helper()
