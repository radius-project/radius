...
type RecipeHandler interface {
	DeployRecipe(ctx context.Context, recipe linkrp.RecipeProperties, envProviders coreDatamodel.Providers) ([]string, error)
}
...
func (handler *azureRecipeHandler) DeployRecipe(ctx context.Context, recipe linkrp.RecipeProperties, envProviders coreDatamodel.Providers) (deployedResources []string, err error) {
