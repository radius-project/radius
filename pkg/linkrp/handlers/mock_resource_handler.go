...
// Source: github.com/project-radius/radius/pkg/linkrp/handlers (interfaces: ResourceHandler)
...
func (m *MockResourceHandler) Delete(arg0 context.Context, arg1 *rpv1.OutputResource) error {
	m.ctrl.T.Helper()
...
func (m *MockResourceHandler) Put(arg0 context.Context, arg1 *rpv1.OutputResource) (resourcemodel.ResourceIdentity, map[string]string, error) {
	m.ctrl.T.Helper()
