...
func (m *MockResourceHandler) Delete(arg0 context.Context, arg1 *v1.OutputResource) error {
	m.ctrl.T.Helper()
...
func (m *MockResourceHandler) Put(arg0 context.Context, arg1 *v1.OutputResource) (resourcemodel.ResourceIdentity, map[string]string, error) {
	m.ctrl.T.Helper()
