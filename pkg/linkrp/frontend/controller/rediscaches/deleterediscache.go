...
func NewDeleteRedisCache(opts frontend_ctrl.Options) (ctrl.Controller, error) {
...
func (redisCache *DeleteRedisCache) Run(ctx context.Context, w http.ResponseWriter, req *http.Request) (rest.Response, error) {
	...
	err = redisCache.StorageClient().Delete(ctx, serviceCtx.ResourceID.String())
	if err != nil {
