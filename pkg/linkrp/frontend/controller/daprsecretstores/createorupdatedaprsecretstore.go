...
func NewCreateOrUpdateDaprSecretStore(opts fctrl.Options) (ctrl.Controller, error) {
...
func (d *CreateOrUpdateDaprSecretStore) Run(ctx context.Context, w http.ResponseWriter, req *http.Request) (rest.Response, error) {
