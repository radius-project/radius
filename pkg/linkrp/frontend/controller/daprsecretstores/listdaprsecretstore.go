...
// ListDaprSecretStores is the controller implementation to get the list of daprSecretStore link resources in the resource group.
...
func (daprSecretStore *ListDaprSecretStores) Run(ctx context.Context, w http.ResponseWriter, req *http.Request) (rest.Response, error) {
