...
func (daprHttpRoute *DeleteDaprInvokeHttpRoute) Run(ctx context.Context, w http.ResponseWriter, req *http.Request) (rest.Response, error) {
	...
	if r, err := daprHttpRoute.PrepareResource(ctx, req, nil, old, etag); r != nil || err != nil {
		return r, err
	}
	...
	if err := daprHttpRoute.StorageClient().Delete(ctx, serviceCtx.ResourceID.String()); err != nil {
