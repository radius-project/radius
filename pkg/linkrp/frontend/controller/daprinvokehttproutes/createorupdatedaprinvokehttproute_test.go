...
func TestCreateOrUpdateDaprInvokeHttpRoute_20230415preview(t *testing.T) {
	...
	for _, testcase := range createNewResourceTestCases {
		t.Run(testcase.desc, func(t *testing.T) {
			...
			if !testcase.shouldFail {
				actualOutput := &v20230415preview.DaprInvokeHTTPRouteResource{}
	...
	updateExistingResourceTestCases := []struct {
		...
		{"update-resource-with-diff-appid", "If-Match", "", "20230415preview_input_appid.json", "resource-etag", false, http.StatusBadRequest, true},
