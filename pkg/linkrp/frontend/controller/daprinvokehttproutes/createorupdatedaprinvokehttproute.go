...
func NewCreateOrUpdateDaprInvokeHttpRoute(opts fctrl.Options) (ctrl.Controller, error) {
...
func (daprHttpRoute *CreateOrUpdateDaprInvokeHttpRoute) Run(ctx context.Context, w http.ResponseWriter, req *http.Request) (rest.Response, error) {
	...
	if r, err := daprHttpRoute.PrepareResource(ctx, req, newResource, old, etag); r != nil || err != nil {
		return r, err
	}
