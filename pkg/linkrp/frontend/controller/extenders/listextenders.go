...
// ListExtenders is the controller implementation to get the list of extender link resources in the resource group.
...
func (extender *ListExtenders) Run(ctx context.Context, w http.ResponseWriter, req *http.Request) (rest.Response, error) {
