...
func NewCreateOrUpdateDaprPubSubBroker(opts fctrl.Options) (ctrl.Controller, error) {
...
func (d *CreateOrUpdateDaprPubSubBroker) Run(ctx context.Context, w http.ResponseWriter, req *http.Request) (rest.Response, error) {
