...
func TestCreateOrUpdateDaprPubSubBroker_20230415preview(t *testing.T) {
	...
	for _, testcase := range createNewResourceTestCases {
		t.Run(testcase.desc, func(t *testing.T) {
			...
			if !testcase.shouldFail {
				actualOutput := &v20230415preview.DaprPubSubBrokerResource{}
	...
	updateExistingResourceTestCases := []struct {
		...
		{"create-new-resource-with-diff-envid", "If-Match", "", "20230415preview_input_diff_env.json", "", false, http.StatusBadRequest, true},
