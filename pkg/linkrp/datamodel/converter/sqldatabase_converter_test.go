...
func TestSqlDatabaseDataModelToVersioned(t *testing.T) {
	testset := []struct {
		...
		{
			"../../api/v20230415preview/testdata/sqldatabaseresourcedatamodel.json",
			"2023-04-15-preview",
			&v20230415preview.SQLDatabaseResource{},
			nil,
		},
		{
			"",
...
func TestSqlDatabaseDataModelFromVersioned(t *testing.T) {
	testset := []struct {
		...
		{
			"../../api/v20230415preview/testdata/sqldatabaseresource.json",
			"2023-04-15-preview",
			nil,
		},
		{
			"../../api/v20230415preview/testdata/sqldatabaseresource-invalid.json",
			"2023-04-15-preview",
