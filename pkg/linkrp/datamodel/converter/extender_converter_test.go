...
func TestExtenderDataModelToVersioned(t *testing.T) {
	testset := []struct {
		...
		{
			"../../api/v20230415preview/testdata/extenderresourcedatamodel.json",
			"2023-04-15-preview",
			&v20230415preview.ExtenderResource{},
			nil,
		},
		{
			"",
...
func TestExtenderDataModelFromVersioned(t *testing.T) {
	testset := []struct {
		...
		{
			"../../api/v20230415preview/testdata/extenderresource.json",
			"2023-04-15-preview",
			nil,
		},
		{
			"../../api/v20230415preview/testdata/extenderresource-invalid.json",
			"2023-04-15-preview",
