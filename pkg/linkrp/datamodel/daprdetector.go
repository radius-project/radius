...
//
// This check is based on the Dapr Component CRD, and only supports Kubernetes. It checks if the Dapr component
// CustomResourceDefinition exists in the Kubernetes cluster and returns a boolean and an error if one occurs.
