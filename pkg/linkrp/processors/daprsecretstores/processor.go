...
func (p *Processor) Process(ctx context.Context, resource *datamodel.DaprSecretStore, options processors.Options) error {
	...
	err = handlers.CheckDaprResourceNameUniqueness(ctx, p.Client, resource.Properties.ComponentName, options.RuntimeConfiguration.Kubernetes.Namespace, resource.Name, linkrp.DaprSecretStoresResourceType)
	if err != nil {
