...
//
// Process implements the processors.Processor interface for SqlDatabase resources. It validates the given resource properties and sets
// the computed values and secrets in the resource, and applies the values from the RecipeOutput.
