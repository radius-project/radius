...
// CreateOrUpdate - Creates or updates a ExtenderResource
...
// method.
func (client *ExtendersClient) CreateOrUpdate(ctx context.Context, extenderName string, resource ExtenderResource, options *ExtendersClientCreateOrUpdateOptions) (ExtendersClientCreateOrUpdateResponse, error) {
...
func (client *ExtendersClient) createOrUpdateCreateRequest(ctx context.Context, extenderName string, resource ExtenderResource, options *ExtendersClientCreateOrUpdateOptions) (*policy.Request, error) {
...
// Delete - Deletes an existing ExtenderResource
// If the operation fails it returns an *azcore.ResponseError type.
// Generated from API version 2022-03-15-privatepreview
// extenderName - Extender name
...
func (client *ExtendersClient) deleteHandleResponse(resp *http.Response) (ExtendersClientDeleteResponse, error) {
	result := ExtendersClientDeleteResponse{}
	if val := resp.Header.Get("Retry-After"); val != "" {
		retryAfter32, err := strconv.ParseInt(val, 10, 32)
		retryAfter := int32(retryAfter32)
		if err != nil {
...
// Get - Retrieves information about a ExtenderResource
// If the operation fails it returns an *azcore.ResponseError type.
// Generated from API version 2022-03-15-privatepreview
// extenderName - Extender name
...
// NewListByRootScopePager - Lists information about all ExtenderResources in the given root scope
// Generated from API version 2022-03-15-privatepreview
