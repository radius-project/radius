...
// BeginCreate - Create a MongoDatabaseResource
// If the operation fails it returns an *azcore.ResponseError type.
// Generated from API version 2022-03-15-privatepreview
// mongoDatabaseName - The name of the MongoDatabase link resource
// resource - Resource create parameters.
// options - MongoDatabasesClientBeginCreateOptions contains the optional parameters for the MongoDatabasesClient.BeginCreate
// method.
func (client *MongoDatabasesClient) BeginCreate(ctx context.Context, mongoDatabaseName string, resource MongoDatabaseResource, options *MongoDatabasesClientBeginCreateOptions) (*runtime.Poller[MongoDatabasesClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.create(ctx, mongoDatabaseName, resource, options)
		if err != nil {
			return nil, err
		}
		return runtime.NewPoller(resp, client.pl, &runtime.NewPollerOptions[MongoDatabasesClientCreateResponse]{
			FinalStateVia: runtime.FinalStateViaAzureAsyncOp,
		})
	} else {
		return runtime.NewPollerFromResumeToken[MongoDatabasesClientCreateResponse](options.ResumeToken, client.pl, nil)
	}
}

// Create - Create a MongoDatabaseResource
// If the operation fails it returns an *azcore.ResponseError type.
// Generated from API version 2022-03-15-privatepreview
func (client *MongoDatabasesClient) create(ctx context.Context, mongoDatabaseName string, resource MongoDatabaseResource, options *MongoDatabasesClientBeginCreateOptions) (*http.Response, error) {
	req, err := client.createCreateRequest(ctx, mongoDatabaseName, resource, options)
	if err != nil {
		return nil, err
	}
...
func (client *MongoDatabasesClient) createCreateRequest(ctx context.Context, mongoDatabaseName string, resource MongoDatabaseResource, options *MongoDatabasesClientBeginCreateOptions) (*policy.Request, error) {
