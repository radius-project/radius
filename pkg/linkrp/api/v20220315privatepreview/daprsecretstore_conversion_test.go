...
func TestDaprSecretStore_ConvertVersionedToDataModel(t *testing.T) {
	...
	for _, payload := range testset {
		...
		require.Equal(t, linkrp.DaprSecretStoresResourceTypeName, convertedResource.Type)
...
func TestDaprSecretStore_ConvertDataModelToVersioned(t *testing.T) {
	...
	for _, payload := range testset {
		...
		require.Equal(t, linkrp.DaprSecretStoresResourceTypeName, *versionedResource.Type)
