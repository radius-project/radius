...
func TestMongoDatabase_ConvertVersionedToDataModel(t *testing.T) {
	...
	for _, payload := range testset {
		...
		require.Equal(t, linkrp.MongoDatabasesResourceTypeName, convertedResource.Type)
...
func TestMongoDatabase_ConvertDataModelToVersioned(t *testing.T) {
	...
	for _, payload := range testset {
		...
		require.Equal(t, linkrp.MongoDatabasesResourceTypeName, *versionedResource.Type)
