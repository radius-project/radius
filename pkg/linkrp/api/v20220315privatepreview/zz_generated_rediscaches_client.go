...
// BeginCreate - Create a RedisCacheResource
// If the operation fails it returns an *azcore.ResponseError type.
// Generated from API version 2022-03-15-privatepreview
// redisCacheName - The name of the RedisCache link resource
// resource - Resource create parameters.
// options - RedisCachesClientBeginCreateOptions contains the optional parameters for the RedisCachesClient.BeginCreate method.
func (client *RedisCachesClient) BeginCreate(ctx context.Context, redisCacheName string, resource RedisCacheResource, options *RedisCachesClientBeginCreateOptions) (*runtime.Poller[RedisCachesClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.create(ctx, redisCacheName, resource, options)
		if err != nil {
			return nil, err
		}
		return runtime.NewPoller(resp, client.pl, &runtime.NewPollerOptions[RedisCachesClientCreateResponse]{
			FinalStateVia: runtime.FinalStateViaAzureAsyncOp,
		})
	} else {
		return runtime.NewPollerFromResumeToken[RedisCachesClientCreateResponse](options.ResumeToken, client.pl, nil)
	}
}

// Create - Create a RedisCacheResource
// If the operation fails it returns an *azcore.ResponseError type.
// Generated from API version 2022-03-15-privatepreview
func (client *RedisCachesClient) create(ctx context.Context, redisCacheName string, resource RedisCacheResource, options *RedisCachesClientBeginCreateOptions) (*http.Response, error) {
	req, err := client.createCreateRequest(ctx, redisCacheName, resource, options)
	if err != nil {
		return nil, err
	}
...
func (client *RedisCachesClient) createCreateRequest(ctx context.Context, redisCacheName string, resource RedisCacheResource, options *RedisCachesClientBeginCreateOptions) (*policy.Request, error) {
