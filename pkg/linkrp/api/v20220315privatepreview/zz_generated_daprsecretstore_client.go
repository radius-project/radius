...
func NewDaprSecretStoreClient(rootScope string, credential azcore.TokenCredential, options *arm.ClientOptions) (*DaprSecretStoreClient, error) {
	cl, err := arm.NewClient(moduleName+".DaprSecretStoreClient", moduleVersion, credential, options)
	if err != nil {
		return nil, err
	}
...
//
// Generated from API version 2022-03-15-privatepreview
//   - options - DaprSecretStoreClientListByRootScopeOptions contains the optional parameters for the DaprSecretStoreClient.NewListByRootScopePager
//     method.
