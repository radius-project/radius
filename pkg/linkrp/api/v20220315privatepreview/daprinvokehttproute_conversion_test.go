...
func TestDaprInvokeHttpRoute_ConvertVersionedToDataModel(t *testing.T) {
	...
	for _, payload := range testset {
		...
		require.Equal(t, linkrp.DaprInvokeHttpRoutesResourceTypeName, convertedResource.Type)
...
func TestDaprInvokeHttpRoute_ConvertDataModelToVersioned(t *testing.T) {
	...
	for _, payload := range testset {
		...
		require.Equal(t, linkrp.DaprInvokeHttpRoutesResourceTypeName, *versionedResource.Type)
