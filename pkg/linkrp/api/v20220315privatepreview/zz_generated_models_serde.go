...
// MarshalJSON implements the json.Marshaller interface for type MongoDatabaseRecipeProperties.
func (m MongoDatabaseRecipeProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "application", m.Application)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type MongoDatabaseRecipeProperties.
func (m *MongoDatabaseRecipeProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type MongoDatabaseResourceProperties.
func (m MongoDatabaseResourceProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "application", m.Application)
	populate(objectMap, "database", m.Database)
	populate(objectMap, "environment", m.Environment)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type MongoDatabaseResourceProperties.
func (m *MongoDatabaseResourceProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type MongoDatabaseValuesProperties.
func (m MongoDatabaseValuesProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "application", m.Application)
	populate(objectMap, "database", m.Database)
	populate(objectMap, "environment", m.Environment)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type MongoDatabaseValuesProperties.
func (m *MongoDatabaseValuesProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", m, err)
	}
