...
// MarshalJSON implements the json.Marshaller interface for type RecipeMongoDatabaseRequestProperties.
func (r RecipeMongoDatabaseRequestProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "application", r.Application)
	populate(objectMap, "environment", r.Environment)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type RecipeMongoDatabaseRequestProperties.
func (r *RecipeMongoDatabaseRequestProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ResourceMongoDatabaseRequestProperties.
func (r ResourceMongoDatabaseRequestProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
	populate(objectMap, "application", r.Application)
	populate(objectMap, "database", r.Database)
	populate(objectMap, "environment", r.Environment)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ResourceMongoDatabaseRequestProperties.
func (r *ResourceMongoDatabaseRequestProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", r, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type ValuesMongoDatabaseRequestProperties.
func (v ValuesMongoDatabaseRequestProperties) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]interface{})
...
// UnmarshalJSON implements the json.Unmarshaller interface for type ValuesMongoDatabaseRequestProperties.
func (v *ValuesMongoDatabaseRequestProperties) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
