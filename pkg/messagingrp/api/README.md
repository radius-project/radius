...
These settings apply only when `--tag=messaging-2023-10-01-preview` is specified on the command line.

```yaml $(tag) == 'messaging-2023-10-01-preview'
input-file:
...
```yaml $(tag) != ''
version: 3.*.*
use: "@autorest/go@4.0.0-preview.74"
