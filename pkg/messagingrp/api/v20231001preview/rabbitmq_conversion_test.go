	...
	testCases := []struct {
	...
	}{
		{
			...
			expected: &RabbitMQQueueResource{
				...
				ID:   new("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/radius-test-rg/providers/Applications.Messaging/rabbitMQQueues/rabbitmq0"),
				Name: new("rabbitmq0"),
