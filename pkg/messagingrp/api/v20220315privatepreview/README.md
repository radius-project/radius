...
2. Run autorest.
```bash
autorest README.md --tag=messaging-2022-03-15-privatepreview
```
...
#### Tag: messaging-2022-03-15-privatepreview

These settings apply only when `--tag=messaging-2022-03-15-privatepreview` is specified on the command line.

```yaml $(tag) == 'messaging-2022-03-15-privatepreview'
input-file:
  - ../../../../swagger/specification/applications/resource-manager/Applications.Messaging/preview/2022-03-15-privatepreview/openapi.json
modelerfour: 
