...
// ResourceProviderDataModelToVersioned converts version agnostic plane datamodel to versioned model.
...
// ResourceProviderDataModelFromVersioned converts versioned plane model to datamodel.
