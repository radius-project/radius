...
// Source: github.com/project-radius/radius/pkg/ucp/secret (interfaces: Client)
...
func (m *MockClient) CreateOrUpdate(arg0 context.Context, arg1 string, arg2 interface{}) error {
	m.ctrl.T.Helper()
...
func (m *MockClient) List(arg0 context.Context, arg1, arg2, arg3 string) ([]string, error) {
	m.ctrl.T.Helper()
...
func (mr *MockClientMockRecorder) List(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "List", reflect.TypeOf((*MockClient)(nil).List), arg0, arg1, arg2, arg3)
}
