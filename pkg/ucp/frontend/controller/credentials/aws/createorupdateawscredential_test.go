...
func Test_AWS_Credential(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			credentialVersionedInput := &v20230415preview.AWSCredentialResource{}
...
func getAwsResponse() armrpc_rest.Response {
	return armrpc_rest.NewOKResponseWithHeaders(&v20230415preview.AWSCredentialResource{
		...
		Properties: &v20230415preview.AWSAccessKeyCredentialProperties{
