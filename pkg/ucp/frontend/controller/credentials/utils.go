...
// 
//	GetSecretName takes an ID and returns a normalized string based on the PlaneNamespace and Name of the ID, replacing any 
//	"/" with "-". If an error occurs, the function will return an empty string.
