...
type ProxyController struct {
	...
	// embeddedTransport is the http.RoundTripper to use for internal requests. Can be overridden for testing.
...
func NewProxyController(opts armrpc_controller.Options, transport http.RoundTripper, embeddedTransport http.RoundTripper) (armrpc_controller.Controller, error) {
