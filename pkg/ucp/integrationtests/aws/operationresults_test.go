...
func Test_GetOperationResults(t *testing.T) {
	...
	operationResultsRequest, err := http.NewRequest("GET", ucp.URL+basePath+testProxyRequestAWSAsyncPath+"/operationResults/"+strings.ToLower(testAWSRequestToken), nil)
