...
func NewAzurePlanesClient(credential azcore.TokenCredential, options *arm.ClientOptions) (*AzurePlanesClient, error) {
	cl, err := arm.NewClient(moduleName+".AzurePlanesClient", moduleVersion, credential, options)
	if err != nil {
		return nil, err
	}
...
func (client *AzurePlanesClient) createOrUpdateCreateRequest(ctx context.Context, planeName string, resource AzurePlaneResource, options *AzurePlanesClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *AzurePlanesClient) deleteCreateRequest(ctx context.Context, planeName string, options *AzurePlanesClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/planes/azure/{planeName}"
	if planeName == "" {
		return nil, errors.New("parameter planeName cannot be empty")
	}
...
func (client *AzurePlanesClient) getCreateRequest(ctx context.Context, planeName string, options *AzurePlanesClientGetOptions) (*policy.Request, error) {
	urlPath := "/planes/azure/{planeName}"
	if planeName == "" {
		return nil, errors.New("parameter planeName cannot be empty")
	}
	...
	return runtime.NewPager(runtime.PagingHandler[AzurePlanesClientListResponse]{
		...
		Fetcher: func(ctx context.Context, page *AzurePlanesClientListResponse) (AzurePlanesClientListResponse, error) {
			...
			if !runtime.HasStatusCode(resp, http.StatusOK) {
				return AzurePlanesClientListResponse{}, runtime.NewResponseError(resp)
			}
...
func (client *AzurePlanesClient) listCreateRequest(ctx context.Context, options *AzurePlanesClientListOptions) (*policy.Request, error) {
...
func (client *AzurePlanesClient) updateCreateRequest(ctx context.Context, planeName string, properties AzurePlaneResourceTagsUpdate, options *AzurePlanesClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/planes/azure/{planeName}"
	if planeName == "" {
		return nil, errors.New("parameter planeName cannot be empty")
	}
