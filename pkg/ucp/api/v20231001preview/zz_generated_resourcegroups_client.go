...
func (client *ResourceGroupsClient) CreateOrUpdate(ctx context.Context, planeName string, resourceGroupName string, resource ResourceGroupResource, options *ResourceGroupsClientCreateOrUpdateOptions) (ResourceGroupsClientCreateOrUpdateResponse, error) {
	var err error
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ResourceGroupsClient.CreateOrUpdate")
...
func (client *ResourceGroupsClient) createOrUpdateCreateRequest(ctx context.Context, planeName string, resourceGroupName string, resource ResourceGroupResource, _ *ResourceGroupsClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *ResourceGroupsClient) Delete(ctx context.Context, planeName string, resourceGroupName string, options *ResourceGroupsClientDeleteOptions) (ResourceGroupsClientDeleteResponse, error) {
	var err error
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ResourceGroupsClient.Delete")
...
func (client *ResourceGroupsClient) deleteCreateRequest(ctx context.Context, planeName string, resourceGroupName string, _ *ResourceGroupsClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/planes/radius/{planeName}/resourcegroups/{resourceGroupName}"
	if planeName == "" {
		return nil, errors.New("parameter planeName cannot be empty")
	}
...
func (client *ResourceGroupsClient) Get(ctx context.Context, planeName string, resourceGroupName string, options *ResourceGroupsClientGetOptions) (ResourceGroupsClientGetResponse, error) {
	var err error
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ResourceGroupsClient.Get")
...
func (client *ResourceGroupsClient) getCreateRequest(ctx context.Context, planeName string, resourceGroupName string, _ *ResourceGroupsClientGetOptions) (*policy.Request, error) {
	urlPath := "/planes/radius/{planeName}/resourcegroups/{resourceGroupName}"
	if planeName == "" {
		return nil, errors.New("parameter planeName cannot be empty")
	}
...
func (client *ResourceGroupsClient) Update(ctx context.Context, planeName string, resourceGroupName string, properties ResourceGroupResourceTagsUpdate, options *ResourceGroupsClientUpdateOptions) (ResourceGroupsClientUpdateResponse, error) {
	var err error
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "ResourceGroupsClient.Update")
...
func (client *ResourceGroupsClient) updateCreateRequest(ctx context.Context, planeName string, resourceGroupName string, properties ResourceGroupResourceTagsUpdate, _ *ResourceGroupsClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/planes/radius/{planeName}/resourcegroups/{resourceGroupName}"
	if planeName == "" {
		return nil, errors.New("parameter planeName cannot be empty")
	}
