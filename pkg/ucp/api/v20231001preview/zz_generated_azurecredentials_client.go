...
func (client *AzureCredentialsClient) CreateOrUpdate(ctx context.Context, planeName string, credentialName string, resource AzureCredentialResource, options *AzureCredentialsClientCreateOrUpdateOptions) (AzureCredentialsClientCreateOrUpdateResponse, error) {
	var err error
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "AzureCredentialsClient.CreateOrUpdate")
...
func (client *AzureCredentialsClient) createOrUpdateCreateRequest(ctx context.Context, planeName string, credentialName string, resource AzureCredentialResource, _ *AzureCredentialsClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *AzureCredentialsClient) Delete(ctx context.Context, planeName string, credentialName string, options *AzureCredentialsClientDeleteOptions) (AzureCredentialsClientDeleteResponse, error) {
	var err error
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "AzureCredentialsClient.Delete")
...
func (client *AzureCredentialsClient) deleteCreateRequest(ctx context.Context, planeName string, credentialName string, _ *AzureCredentialsClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/planes/azure/{planeName}/providers/System.Azure/credentials/{credentialName}"
	if planeName == "" {
		return nil, errors.New("parameter planeName cannot be empty")
	}
...
func (client *AzureCredentialsClient) Get(ctx context.Context, planeName string, credentialName string, options *AzureCredentialsClientGetOptions) (AzureCredentialsClientGetResponse, error) {
	var err error
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "AzureCredentialsClient.Get")
...
func (client *AzureCredentialsClient) getCreateRequest(ctx context.Context, planeName string, credentialName string, _ *AzureCredentialsClientGetOptions) (*policy.Request, error) {
	urlPath := "/planes/azure/{planeName}/providers/System.Azure/credentials/{credentialName}"
	if planeName == "" {
		return nil, errors.New("parameter planeName cannot be empty")
	}
...
func (client *AzureCredentialsClient) Update(ctx context.Context, planeName string, credentialName string, properties AzureCredentialResourceTagsUpdate, options *AzureCredentialsClientUpdateOptions) (AzureCredentialsClientUpdateResponse, error) {
	var err error
	ctx = context.WithValue(ctx, runtime.CtxAPINameKey{}, "AzureCredentialsClient.Update")
...
func (client *AzureCredentialsClient) updateCreateRequest(ctx context.Context, planeName string, credentialName string, properties AzureCredentialResourceTagsUpdate, _ *AzureCredentialsClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/planes/azure/{planeName}/providers/System.Azure/credentials/{credentialName}"
	if planeName == "" {
		return nil, errors.New("parameter planeName cannot be empty")
	}
