...
// The returned RadiusPlanesServerTransport instance is connected to an instance of v20231001preview.RadiusPlanesClient via the
...
func (r *RadiusPlanesServerTransport) Do(req *http.Request) (*http.Response, error) {
...
func (r *RadiusPlanesServerTransport) dispatchToMethodFake(req *http.Request, method string) (*http.Response, error) {
	...
	go func() {
		...
		if !intercepted {
			switch method {
			case "RadiusPlanesClient.BeginCreateOrUpdate":
				res.resp, res.err = r.dispatchBeginCreateOrUpdate(req)
			case "RadiusPlanesClient.BeginDelete":
				res.resp, res.err = r.dispatchBeginDelete(req)
			case "RadiusPlanesClient.Get":
				res.resp, res.err = r.dispatchGet(req)
			case "RadiusPlanesClient.NewListPager":
...
func (r *RadiusPlanesServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	if r.srv.BeginCreateOrUpdate == nil {
		return nil, &nonRetriableError{errors.New("fake for method BeginCreateOrUpdate not implemented")}
	}
	beginCreateOrUpdate := r.beginCreateOrUpdate.get(req)
	if beginCreateOrUpdate == nil {
		const regexStr = `/planes/radius/(?P<planeName>[a-zA-Z0-9._~%!$&'()*+,;=:@-]+)`
...
func (r *RadiusPlanesServerTransport) dispatchBeginDelete(req *http.Request) (*http.Response, error) {
...
func (r *RadiusPlanesServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	if r.srv.Get == nil {
	...
	respr, errRespr := r.srv.Get(req.Context(), planeNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	...
	resp, err := server.MarshalResponseAsJSON(respContent, server.GetResponse(respr).RadiusPlaneResource, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
...
func (r *RadiusPlanesServerTransport) dispatchNewListPager(req *http.Request) (*http.Response, error) {
...
func (r *RadiusPlanesServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
...
// set this to conditionally intercept incoming requests to RadiusPlanesServerTransport
var radiusPlanesServerTransportInterceptor interface {
