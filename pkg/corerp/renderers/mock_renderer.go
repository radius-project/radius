...
//
//	mockgen -destination=./mock_renderer.go -package=renderers github.com/radius-project/radius/pkg/corerp/renderers Renderer
//
...
func (mr *MockRendererMockRecorder) GetDependencyIDs(arg0, arg1 any) *gomock.Call {
...
func (mr *MockRendererMockRecorder) Render(arg0, arg1, arg2 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
