...
//
//	mockgen -destination=./mock_resource_handler.go -package=handlers -self_package github.com/radius-project/radius/pkg/corerp/handlers github.com/radius-project/radius/pkg/corerp/handlers ResourceHandler
//
...
func (mr *MockResourceHandlerMockRecorder) Delete(arg0, arg1 any) *gomock.Call {
...
func (mr *MockResourceHandlerMockRecorder) Put(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
