...
type EnvironmentProperties_v20250801preview struct {
	...
	// TerraformSettings is the resource ID of a Radius.Core/terraformSettings resource.
	TerraformSettings string `json:"terraformSettings,omitempty"`

	// BicepSettings is the resource ID of a Radius.Core/bicepSettings resource.
