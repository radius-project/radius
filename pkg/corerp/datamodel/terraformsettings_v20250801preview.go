...
type TerraformCliConfiguration struct {
	ProviderInstallation *TerraformProviderInstallationConfiguration `json:"provider_installation,omitempty"`
...
type TerraformProviderInstallationConfiguration struct {
	NetworkMirror *TerraformNetworkMirrorConfiguration `json:"network_mirror,omitempty"`
