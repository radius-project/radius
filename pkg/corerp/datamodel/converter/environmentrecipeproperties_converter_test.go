...
func TestEnvironmentRecipePropertiesDataModelToVersioned(t *testing.T) {
	testset := []struct {
		...
		{
			"../../api/v20231001preview/testdata/environmentrecipepropertiesdatamodel.json",
			"2023-10-01-preview",
			&v20231001preview.RecipeGetMetadataResponse{},
			nil,
		},
...
func TestRecipeDatamodelFromVersioned(t *testing.T) {
	testset := []struct {
		...
		{
			"../../api/v20231001preview/testdata/reciperesource.json",
			"2023-10-01-preview",
			nil,
		},
		// TODO: add new conversion tests.
