...
func TestFromRequest(t *testing.T) {
	...
	require.Equal(t, "/subscriptions/00001b53-0000-0000-0000-00006235a42c/resourceGroups/radius-test-rg/providers/Applications.Core/environments/env0", serviceCtx.ResourceID.ID)
	require.Equal(t, "00001b53-0000-0000-0000-00006235a42c", serviceCtx.ResourceID.SubscriptionID)
