...
// Source: github.com/project-radius/radius/pkg/corerp/asyncoperation (interfaces: StatusManager)
...
import (
	...
	servicecontext "github.com/project-radius/radius/pkg/corerp/servicecontext"
...
func (m *MockStatusManager) Update(arg0 context.Context, arg1 string, arg2 uuid.UUID, arg3 basedatamodel.ProvisioningStates, arg4 *time.Time, arg5 *armerrors.ErrorDetails) error {
	m.ctrl.T.Helper()
