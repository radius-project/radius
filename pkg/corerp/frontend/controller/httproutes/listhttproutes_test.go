...
func TestListHTTPRoutesRun_20220315PrivatePreview(t *testing.T) {
	...
	t.Run("list zero resources", func(t *testing.T) {
		...
		ctl, err := NewListHTTPRoutes(mStorageClient, nil, nil)
	...
	httprouteCases := []struct {
		...
		{"list-httproutes-more-items-than-top", 10, 5, "5", true},
		{"list-httproutes-less-items-than-top", 5, 5, "10", false},
		{"list-httproutes-no-top", 5, 5, "", false},
	}

	for _, tt := range httprouteCases {
