...
func NewListContainers(ds store.StorageClient, sm manager.StatusManager, dp deployment.DeploymentProcessor) (ctrl.Controller, error) {
	return &ListContainers{ctrl.NewBaseController(ds, sm, dp)}, nil
}
