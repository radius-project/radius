...
func NewGetGateway(ds store.StorageClient, sm manager.StatusManager, dp deployment.DeploymentProcessor) (ctrl.Controller, error) {
	return &GetGateway{ctrl.NewBaseController(ds, sm, dp)}, nil
}
