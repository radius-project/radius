...
func TestPopulateKubernetesExtension_invalid_property(t *testing.T) {
	...
	t.Run("invalid namespace", func(t *testing.T) {
		...
		require.Equal(t, res.Body.Error.Message, "'invalid-nameinvalid-nameinvalid-nameinvalid-nameinvalid-nameinvalid-name' is the invalid namespace. namespace must be at most 63 alphanumeric characters or '-'. Please specify the valid namespace in properties.extensions[*].kubernetesNamespaceOverride.")
	})
