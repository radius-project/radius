...
func NewGetApplication(ds store.StorageClient, sm manager.StatusManager, dp deployment.DeploymentProcessor) (ctrl.Controller, error) {
	return &GetApplication{ctrl.NewBaseController(ds, sm, dp)}, nil
}
