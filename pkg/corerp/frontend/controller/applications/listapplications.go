...
func NewListApplications(ds store.StorageClient, sm manager.StatusManager, dp deployment.DeploymentProcessor) (ctrl.Controller, error) {
	return &ListApplications{ctrl.NewBaseController(ds, sm, dp)}, nil
}
