...
func NewConnectorService(options hostoptions.HostOptions) *ConnectorService {
	return &ConnectorService{
		Options: options,
	}
}

func (s *ConnectorService) Name() string {
	return "Applications.Connector RP frontend"
}

func (s *ConnectorService) Run(ctx context.Context) error {
