...
type BicepAwsIrsaAuthentication struct {
	...
	// Resource ID of the Radius.Security/secrets entry containing the IRSA token.
	Secret *string
}
...
type BicepAzureWorkloadIdentityAuthentication struct {
	...
	// Resource ID of the Radius.Security/secrets entry containing the workload identity token.
	Secret *string
...
type BicepBasicAuthentication struct {
	// Resource ID of the Radius.Security/secrets entry containing the password.
	Secret *string
...
type TerraformCredentialConfiguration struct {
	// Resource ID of the Radius.Security/secrets entry containing the credential values (for example token).
	Secret *string
}
