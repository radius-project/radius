...
func (client *ApplicationsClient) getGraphCreateRequest(ctx context.Context, applicationName string, body any, _ *ApplicationsClientGetGraphOptions) (*policy.Request, error) {
