...
type EnvironmentsServer struct {
	...
	CreateOrUpdate func(ctx context.Context, rootScope string, environmentName string, resource v20250801preview.EnvironmentResource, options *v20250801preview.EnvironmentsClientCreateOrUpdateOptions) (resp azfake.Responder[v20250801preview.EnvironmentsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method EnvironmentsClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, rootScope string, environmentName string, options *v20250801preview.EnvironmentsClientDeleteOptions) (resp azfake.Responder[v20250801preview.EnvironmentsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method EnvironmentsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, rootScope string, environmentName string, options *v20250801preview.EnvironmentsClientGetOptions) (resp azfake.Responder[v20250801preview.EnvironmentsClientGetResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, rootScope string, environmentName string, properties v20250801preview.EnvironmentResource, options *v20250801preview.EnvironmentsClientUpdateOptions) (resp azfake.Responder[v20250801preview.EnvironmentsClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (e *EnvironmentsServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := e.srv.CreateOrUpdate(req.Context(), rootScopeParam, environmentNameParam, body, nil)
...
func (e *EnvironmentsServerTransport) dispatchDelete(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := e.srv.Delete(req.Context(), rootScopeParam, environmentNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (e *EnvironmentsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := e.srv.Get(req.Context(), rootScopeParam, environmentNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (e *EnvironmentsServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := e.srv.Update(req.Context(), rootScopeParam, environmentNameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
