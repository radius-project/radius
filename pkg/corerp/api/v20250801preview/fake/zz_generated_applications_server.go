...
// ApplicationsServer is a fake server for instances of the v20250801preview.ApplicationsClient type.
type ApplicationsServer struct {
	// CreateOrUpdate is the fake for method ApplicationsClient.CreateOrUpdate
	// HTTP status codes to indicate success: http.StatusOK, http.StatusCreated
	CreateOrUpdate func(ctx context.Context, applicationName string, resource v20250801preview.ApplicationResource, options *v20250801preview.ApplicationsClientCreateOrUpdateOptions) (resp azfake.Responder[v20250801preview.ApplicationsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method ApplicationsClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, applicationName string, options *v20250801preview.ApplicationsClientDeleteOptions) (resp azfake.Responder[v20250801preview.ApplicationsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method ApplicationsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, applicationName string, options *v20250801preview.ApplicationsClientGetOptions) (resp azfake.Responder[v20250801preview.ApplicationsClientGetResponse], errResp azfake.ErrorResponder)

	// GetGraph is the fake for method ApplicationsClient.GetGraph
	// HTTP status codes to indicate success: http.StatusOK
	GetGraph func(ctx context.Context, applicationName string, body any, options *v20250801preview.ApplicationsClientGetGraphOptions) (resp azfake.Responder[v20250801preview.ApplicationsClientGetGraphResponse], errResp azfake.ErrorResponder)
	...
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, applicationName string, properties v20250801preview.ApplicationResourceUpdate, options *v20250801preview.ApplicationsClientUpdateOptions) (resp azfake.Responder[v20250801preview.ApplicationsClientUpdateResponse], errResp azfake.ErrorResponder)
}

// NewApplicationsServerTransport creates a new instance of ApplicationsServerTransport with the provided implementation.
// The returned ApplicationsServerTransport instance is connected to an instance of v20250801preview.ApplicationsClient via the
...
func NewApplicationsServerTransport(srv *ApplicationsServer) *ApplicationsServerTransport {
	return &ApplicationsServerTransport{
		srv:                 srv,
		newListByScopePager: newTracker[azfake.PagerResponder[v20250801preview.ApplicationsClientListByScopeResponse]](),
	}
}

// ApplicationsServerTransport connects instances of v20250801preview.ApplicationsClient to instances of ApplicationsServer.
...
type ApplicationsServerTransport struct {
	...
	newListByScopePager *tracker[azfake.PagerResponder[v20250801preview.ApplicationsClientListByScopeResponse]]
}
...
func (a *ApplicationsServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[v20250801preview.ApplicationResource](req)
	if err != nil {
		return nil, err
	}
...
func (a *ApplicationsServerTransport) dispatchNewListByScopePager(req *http.Request) (*http.Response, error) {
	...
	if newListByScopePager == nil {
		...
		server.PagerResponderInjectNextLinks(newListByScopePager, req, func(page *v20250801preview.ApplicationsClientListByScopeResponse, createLink func() string) {
...
func (a *ApplicationsServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[v20250801preview.ApplicationResourceUpdate](req)
	if err != nil {
		return nil, err
	}
	applicationNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("applicationName")])
