...
type ApplicationsServer struct {
	...
	CreateOrUpdate func(ctx context.Context, rootScope string, applicationName string, resource v20250801preview.ApplicationResource, options *v20250801preview.ApplicationsClientCreateOrUpdateOptions) (resp azfake.Responder[v20250801preview.ApplicationsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method ApplicationsClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, rootScope string, applicationName string, options *v20250801preview.ApplicationsClientDeleteOptions) (resp azfake.Responder[v20250801preview.ApplicationsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method ApplicationsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, rootScope string, applicationName string, options *v20250801preview.ApplicationsClientGetOptions) (resp azfake.Responder[v20250801preview.ApplicationsClientGetResponse], errResp azfake.ErrorResponder)

	// GetGraph is the fake for method ApplicationsClient.GetGraph
	// HTTP status codes to indicate success: http.StatusOK
	GetGraph func(ctx context.Context, rootScope string, applicationName string, body v20250801preview.GetGraphRequest, options *v20250801preview.ApplicationsClientGetGraphOptions) (resp azfake.Responder[v20250801preview.ApplicationsClientGetGraphResponse], errResp azfake.ErrorResponder)
...
func (a *ApplicationsServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := a.srv.CreateOrUpdate(req.Context(), rootScopeParam, applicationNameParam, body, nil)
...
func (a *ApplicationsServerTransport) dispatchDelete(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := a.srv.Delete(req.Context(), rootScopeParam, applicationNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (a *ApplicationsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := a.srv.Get(req.Context(), rootScopeParam, applicationNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (a *ApplicationsServerTransport) dispatchGetGraph(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[v20250801preview.GetGraphRequest](req)
	if err != nil {
		return nil, err
	}
	rootScopeParam, err := url.PathUnescape(matches[regex.SubexpIndex("rootScope")])
	...
	respr, errRespr := a.srv.GetGraph(req.Context(), rootScopeParam, applicationNameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (a *ApplicationsServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := a.srv.Update(req.Context(), rootScopeParam, applicationNameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
