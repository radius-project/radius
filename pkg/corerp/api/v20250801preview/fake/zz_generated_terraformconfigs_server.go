...
type TerraformConfigsServer struct {
	...
	CreateOrUpdate func(ctx context.Context, terraformConfigName string, resource v20250801preview.TerraformConfigResource, options *v20250801preview.TerraformConfigsClientCreateOrUpdateOptions) (resp azfake.Responder[v20250801preview.TerraformConfigsClientCreateOrUpdateResponse], errResp azfake.ErrorResponder)

	// Delete is the fake for method TerraformConfigsClient.Delete
	// HTTP status codes to indicate success: http.StatusOK, http.StatusNoContent
	Delete func(ctx context.Context, terraformConfigName string, options *v20250801preview.TerraformConfigsClientDeleteOptions) (resp azfake.Responder[v20250801preview.TerraformConfigsClientDeleteResponse], errResp azfake.ErrorResponder)

	// Get is the fake for method TerraformConfigsClient.Get
	// HTTP status codes to indicate success: http.StatusOK
	Get func(ctx context.Context, terraformConfigName string, options *v20250801preview.TerraformConfigsClientGetOptions) (resp azfake.Responder[v20250801preview.TerraformConfigsClientGetResponse], errResp azfake.ErrorResponder)

	// NewListByScopePager is the fake for method TerraformConfigsClient.NewListByScopePager
	// HTTP status codes to indicate success: http.StatusOK
	NewListByScopePager func(options *v20250801preview.TerraformConfigsClientListByScopeOptions) (resp azfake.PagerResponder[v20250801preview.TerraformConfigsClientListByScopeResponse])

	// Update is the fake for method TerraformConfigsClient.Update
	// HTTP status codes to indicate success: http.StatusOK
	Update func(ctx context.Context, terraformConfigName string, properties v20250801preview.TerraformConfigResourceUpdate, options *v20250801preview.TerraformConfigsClientUpdateOptions) (resp azfake.Responder[v20250801preview.TerraformConfigsClientUpdateResponse], errResp azfake.ErrorResponder)
}
...
func (t *TerraformConfigsServerTransport) dispatchCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := t.srv.CreateOrUpdate(req.Context(), terraformConfigNameParam, body, nil)
...
func (t *TerraformConfigsServerTransport) dispatchDelete(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := t.srv.Delete(req.Context(), terraformConfigNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (t *TerraformConfigsServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	respr, errRespr := t.srv.Get(req.Context(), terraformConfigNameParam, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
...
func (t *TerraformConfigsServerTransport) dispatchUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[v20250801preview.TerraformConfigResourceUpdate](req)
	if err != nil {
		return nil, err
	}
	terraformConfigNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("terraformConfigName")])
	...
	respr, errRespr := t.srv.Update(req.Context(), terraformConfigNameParam, body, nil)
	if respErr := server.GetError(errRespr, req); respErr != nil {
		return nil, respErr
	}
	respContent := server.GetResponseContent(respr)
