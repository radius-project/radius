...
func (client *VolumesClient) createOrUpdateCreateRequest(ctx context.Context, volumeName string, resource VolumeResource, _ *VolumesClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *VolumesClient) deleteCreateRequest(ctx context.Context, volumeName string, _ *VolumesClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/{rootScope}/providers/Applications.Core/volumes/{volumeName}"
	urlPath = strings.ReplaceAll(urlPath, "{rootScope}", client.rootScope)
	if volumeName == "" {
		return nil, errors.New("parameter volumeName cannot be empty")
...
func (client *VolumesClient) getCreateRequest(ctx context.Context, volumeName string, _ *VolumesClientGetOptions) (*policy.Request, error) {
	urlPath := "/{rootScope}/providers/Applications.Core/volumes/{volumeName}"
	urlPath = strings.ReplaceAll(urlPath, "{rootScope}", client.rootScope)
	if volumeName == "" {
		return nil, errors.New("parameter volumeName cannot be empty")
...
func (client *VolumesClient) listByScopeCreateRequest(ctx context.Context, _ *VolumesClientListByScopeOptions) (*policy.Request, error) {
...
func (client *VolumesClient) updateCreateRequest(ctx context.Context, volumeName string, properties VolumeResourceUpdate, _ *VolumesClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/{rootScope}/providers/Applications.Core/volumes/{volumeName}"
	urlPath = strings.ReplaceAll(urlPath, "{rootScope}", client.rootScope)
	if volumeName == "" {
		return nil, errors.New("parameter volumeName cannot be empty")
