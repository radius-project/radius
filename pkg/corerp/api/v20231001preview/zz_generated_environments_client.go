...
//     method.
func (client *EnvironmentsClient) CreateOrUpdate(ctx context.Context, rootScope string, environmentName string, resource EnvironmentResource, options *EnvironmentsClientCreateOrUpdateOptions) (EnvironmentsClientCreateOrUpdateResponse, error) {
	var err error
	req, err := client.createOrUpdateCreateRequest(ctx, rootScope, environmentName, resource, options)
	if err != nil {
...
func (client *EnvironmentsClient) createOrUpdateCreateRequest(ctx context.Context, rootScope string, environmentName string, resource EnvironmentResource, _ *EnvironmentsClientCreateOrUpdateOptions) (*policy.Request, error) {
...
func (client *EnvironmentsClient) deleteCreateRequest(ctx context.Context, rootScope string, environmentName string, _ *EnvironmentsClientDeleteOptions) (*policy.Request, error) {
	urlPath := "/{rootScope}/providers/Applications.Core/environments/{environmentName}"
	if rootScope == "" {
		return nil, errors.New("parameter rootScope cannot be empty")
	}
...
func (client *EnvironmentsClient) getCreateRequest(ctx context.Context, rootScope string, environmentName string, _ *EnvironmentsClientGetOptions) (*policy.Request, error) {
	urlPath := "/{rootScope}/providers/Applications.Core/environments/{environmentName}"
	if rootScope == "" {
		return nil, errors.New("parameter rootScope cannot be empty")
	}
...
func (client *EnvironmentsClient) getMetadataCreateRequest(ctx context.Context, rootScope string, environmentName string, body RecipeGetMetadata, _ *EnvironmentsClientGetMetadataOptions) (*policy.Request, error) {
...
func (client *EnvironmentsClient) updateCreateRequest(ctx context.Context, rootScope string, environmentName string, properties EnvironmentResource, _ *EnvironmentsClientUpdateOptions) (*policy.Request, error) {
	urlPath := "/{rootScope}/providers/Applications.Core/environments/{environmentName}"
	if rootScope == "" {
		return nil, errors.New("parameter rootScope cannot be empty")
	}
