...
func (client *GatewaysClient) BeginCreate(ctx context.Context, gatewayName string, resource GatewayResource, options *GatewaysClientBeginCreateOptions) (*runtime.Poller[GatewaysClientCreateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		...
		return runtime.NewPollerFromResumeToken(options.ResumeToken, client.internal.Pipeline(), &runtime.NewPollerFromResumeTokenOptions[GatewaysClientCreateResponse]{
			Tracer: client.internal.Tracer(),
		})
	}
}
...
func (client *GatewaysClient) createCreateRequest(ctx context.Context, gatewayName string, resource GatewayResource, _ *GatewaysClientBeginCreateOptions) (*policy.Request, error) {
...
func (client *GatewaysClient) createOrUpdateCreateRequest(ctx context.Context, gatewayName string, properties GatewayResourceUpdate, _ *GatewaysClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
	urlPath := "/{rootScope}/providers/Applications.Core/gateways/{gatewayName}"
	urlPath = strings.ReplaceAll(urlPath, "{rootScope}", client.rootScope)
	if gatewayName == "" {
		return nil, errors.New("parameter gatewayName cannot be empty")
...
func (client *GatewaysClient) deleteCreateRequest(ctx context.Context, gatewayName string, _ *GatewaysClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/{rootScope}/providers/Applications.Core/gateways/{gatewayName}"
	urlPath = strings.ReplaceAll(urlPath, "{rootScope}", client.rootScope)
	if gatewayName == "" {
		return nil, errors.New("parameter gatewayName cannot be empty")
...
func (client *GatewaysClient) getCreateRequest(ctx context.Context, gatewayName string, _ *GatewaysClientGetOptions) (*policy.Request, error) {
	urlPath := "/{rootScope}/providers/Applications.Core/gateways/{gatewayName}"
	urlPath = strings.ReplaceAll(urlPath, "{rootScope}", client.rootScope)
	if gatewayName == "" {
		return nil, errors.New("parameter gatewayName cannot be empty")
...
func (client *GatewaysClient) listByScopeCreateRequest(ctx context.Context, _ *GatewaysClientListByScopeOptions) (*policy.Request, error) {
