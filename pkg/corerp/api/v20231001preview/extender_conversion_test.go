	...
	testset := []struct {
	...
	}{
		{
			...
			expected: &ExtenderResource{
				...
				ID:   new("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/radius-test-rg/providers/Applications.Core/extenders/extender0"),
				Name: new("extender0"),
		...
		},
		{
			...
			expected: &ExtenderResource{
				...
				Properties: &ExtenderProperties{
					...
					ProvisioningState:    new(ProvisioningStateAccepted),
					Recipe:               &Recipe{Name: new("test-recipe"), Parameters: nil},
