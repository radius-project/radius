...
func unmarshalVolumeUpdateClassification(rawMsg json.RawMessage) (VolumeUpdateClassification, error) {
	if rawMsg == nil {
		return nil, nil
	}
	var m map[string]any
	...
	var b VolumeUpdateClassification
	switch m["kind"] {
	case "ephemeral":
		b = &EphemeralVolumeUpdate{}
	case "persistent":
		b = &PersistentVolumeUpdate{}
	default:
		b = &VolumeUpdate{}
	}
	if err := json.Unmarshal(rawMsg, b); err != nil {
...
func unmarshalVolumeUpdateClassificationMap(rawMsg json.RawMessage) (map[string]VolumeUpdateClassification, error) {
	if rawMsg == nil {
		return nil, nil
	}
	var rawMessages map[string]json.RawMessage
	...
	fMap := make(map[string]VolumeUpdateClassification, len(rawMessages))
	for key, rawMessage := range rawMessages {
		f, err := unmarshalVolumeUpdateClassification(rawMessage)
		if err != nil {
			return nil, err
		}
		fMap[key] = f
