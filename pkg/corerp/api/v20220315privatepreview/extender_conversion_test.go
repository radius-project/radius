...
func TestExtender_ConvertVersionedToDataModel(t *testing.T) {
	...
	for _, payload := range testset {
		...
		require.Equal(t, "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/radius-test-rg/providers/Applications.Core/extenders/extender0", convertedResource.ID)
		require.Equal(t, "extender0", convertedResource.Name)
		require.Equal(t, "Applications.Core/extenders", convertedResource.Type)
...
func TestExtender_ConvertDataModelToVersioned(t *testing.T) {
	...
	for _, payload := range testset {
		...
		// assert
		require.NoError(t, err)
		require.Equal(t, "/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/radius-test-rg/providers/Applications.Core/extenders/extender0", *versionedResource.ID)
		require.Equal(t, "extender0", *versionedResource.Name)
		require.Equal(t, "Applications.Core/extenders", *versionedResource.Type)
