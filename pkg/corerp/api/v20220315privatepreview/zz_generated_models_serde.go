...
func (e EnvironmentProperties) MarshalJSON() ([]byte, error) {
	...
	populate(objectMap, "useRadiusOwnedRecipes", e.UseRadiusOwnedRecipes)
	return json.Marshal(objectMap)
}
...
func (e *EnvironmentProperties) UnmarshalJSON(data []byte) error {
	...
	for key, val := range rawMsg {
		...
		case "recipes":
				...
				delete(rawMsg, key)
		case "useRadiusOwnedRecipes":
				err = unpopulate(val, "UseRadiusOwnedRecipes", &e.UseRadiusOwnedRecipes)
				delete(rawMsg, key)
		}
		if err != nil {
			return fmt.Errorf("unmarshalling type %T: %v", e, err)
