...
func TestValidateVersionForPath(t *testing.T) {
	tests := []struct {
		...
		{name: "path traversal basic", version: "../../../etc", wantErr: true, errMsg: "path traversal"},
		{name: "path traversal with version", version: "1.0.0/../../../etc", wantErr: true, errMsg: "path traversal"},
		{name: "double dot alone", version: "..", wantErr: true, errMsg: "path traversal"},
		{name: "double dot in middle", version: "1..2", wantErr: true, errMsg: "path traversal"},
