...
func (handler *daprSecretStoreGenericHandler) Put(ctx context.Context, options *PutOptions) (map[string]string, error) {
	...
	item, err := handler.PatchDaprSecretStore(ctx, properties, *options)
	if err != nil {
		return nil, err
	}
...
func (handler *daprSecretStoreGenericHandler) PatchDaprSecretStore(ctx context.Context, properties map[string]string, options PutOptions) (unstructured.Unstructured, error) {
...
func (handler *daprSecretStoreGenericHandler) Delete(ctx context.Context, options DeleteOptions) error {
	...
	err := handler.DeleteDaprSecretStore(ctx, properties)
	if err != nil {
		return err
	}
...
func (handler *daprSecretStoreGenericHandler) DeleteDaprSecretStore(ctx context.Context, properties map[string]string) error {
