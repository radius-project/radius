...
//
//	mockgen -destination=./mock_config_loader.go -package=configloader -self_package github.com/radius-project/radius/pkg/recipes/configloader github.com/radius-project/radius/pkg/recipes/configloader ConfigurationLoader
//
...
func (mr *MockConfigurationLoaderMockRecorder) LoadConfiguration(arg0, arg1 any) *gomock.Call {
...
func (mr *MockConfigurationLoaderMockRecorder) LoadRecipe(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
