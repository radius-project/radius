...
// Source: github.com/project-radius/radius/pkg/recipes (interfaces: ConfigurationLoader)
...
func (m *MockConfigurationLoader) Load(arg0 context.Context, arg1 recipes.RecipeMetadata) (*recipes.Configuration, error) {
	m.ctrl.T.Helper()
...
func (mr *MockConfigurationLoaderMockRecorder) Load(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Load", reflect.TypeOf((*MockConfigurationLoader)(nil).Load), arg0, arg1)
}

// Lookup mocks base method.
func (m *MockConfigurationLoader) Lookup(arg0 context.Context, arg1 recipes.RecipeMetadata) (*recipes.RecipeDefinition, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Lookup", arg0, arg1)
	ret0, _ := ret[0].(*recipes.RecipeDefinition)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
