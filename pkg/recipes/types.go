...
type Engine interface {
	Execute(ctx context.Context, recipe Recipe) (*Result, error)
}
...
type Driver interface {
	Execute(ctx context.Context, configuration Configuration, recipe Recipe, definition Definition) (*Result, error)
}
