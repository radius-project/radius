...
type Provider interface {
	...
	// BuildRequiredProvider generates the Terraform required_provider configuration for the provider.
	// Returns required provider definition with source and version information.
