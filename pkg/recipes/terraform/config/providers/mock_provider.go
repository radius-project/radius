...
//
//	mockgen -destination=./mock_provider.go -package=providers -self_package github.com/radius-project/radius/pkg/recipes/terraform/config/providers github.com/radius-project/radius/pkg/recipes/terraform/config/providers Provider
//
...
func (mr *MockProviderMockRecorder) BuildConfig(arg0, arg1 any) *gomock.Call {
