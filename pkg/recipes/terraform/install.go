...
const (
	...
	// Global shared terraform binary paths
	defaultGlobalTerraformDir    = "/terraform"
	defaultGlobalTerraformBinary = "/terraform/terraform"
	defaultGlobalMarkerFile      = "/terraform/.terraform-ready"
)
