...
// Source: github.com/project-radius/radius/pkg/recipes (interfaces: Driver)
...
func (m *MockDriver) Execute(arg0 context.Context, arg1 recipes.Configuration, arg2 recipes.RecipeMetadata, arg3 recipes.RecipeDefinition) (*recipes.RecipeResult, error) {
	m.ctrl.T.Helper()
