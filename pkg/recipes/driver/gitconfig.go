...
func addSecretsToGitConfig(secrets map[string]string, recipeMetadata *recipes.ResourceMetadata, templatePath string) error {
...
func unsetSecretsFromGitConfig(secrets map[string]string, templatePath string) error {
