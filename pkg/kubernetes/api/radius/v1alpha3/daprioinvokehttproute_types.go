...
type DaprIOInvokeHttpRoute struct {
...
//+kubebuilder:object:root=true
type DaprIOInvokeHttpRouteList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []DaprIOInvokeHttpRoute `json:"items"`
}

func init() {
	SchemeBuilder.Register(&DaprIOInvokeHttpRoute{}, &DaprIOInvokeHttpRouteList{})
}
