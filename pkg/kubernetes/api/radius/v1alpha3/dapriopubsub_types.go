...
//+kubebuilder:object:root=true
type DaprIOPubSubTopicList struct {
	metav1.TypeMeta `json:",inline"`
	metav1.ListMeta `json:"metadata,omitempty"`
	Items           []DaprIOPubSubTopic `json:"items"`
}

func init() {
	SchemeBuilder.Register(&DaprIOPubSubTopic{}, &DaprIOPubSubTopicList{})
}
