...
type evaluator struct {
	Template  armtemplate.DeploymentTemplate
...
func (eva *evaluator) VisitPropertyAccess(node *armexpr.PropertyAccessNode) error {
	...
	// TODO need to make sure host, port, url, scheme are all set for access
	if !ok {
...
func (eva *evaluator) EvaluateReference(id interface{}) (map[string]interface{}, error) {
...
func (eva *evaluator) EvaluateVariable(variable interface{}) (interface{}, error) {
