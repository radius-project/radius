...
func NewKubernetesModel(k8s client.Client) model.ApplicationModel {
	renderers := map[string]renderers.Renderer{
		...
		daprstatestorev1alpha3.ResourceType: &daprstatestorev1alpha3.Renderer{StateStores: daprstatestorev1alpha3.SupportedKubernetesStateStoreKindValues},
		mongodbv1alpha3.ResourceType:        &mongodbv1alpha3.KubernetesRenderer{},
		rabbitmqv1alpha3.ResourceType:       &rabbitmqv1alpha3.Renderer{},
