...
func TestExtractCategory(t *testing.T) {
	tests := []struct {
		...
		{"azure-network-security", "Network"},
		{"rds-database", "Data"},
		{"postgres-db", "Data"},
		{"kubernetes-redis", "Data"},
		{"s3-storage", "Storage"},
...
func TestFormatDefaultValue(t *testing.T) {
	tests := []struct {
		...
		{"string with quotes", `"quoted string"`, "quoted string"},
		{"boolean true", true, "true"},
		{"boolean false", false, "false"},
		{"integer", 42, "42"},
		{"float", 3.14, "3.14"},
		{"empty array", []interface{}{}, "[]"},
		{"string array", []interface{}{"item1", "item2", "item3"}, "[item1, item2, item3]"},
		{"mixed array", []interface{}{"string", 42, true}, "[string, 42, true]"},
