...
func (handler *azureServiceBusBaseHandler) GetHealthState(ctx context.Context, resourceInfo healthcontract.ResourceInfo) healthcontract.ResourceHealthDataMessage {
