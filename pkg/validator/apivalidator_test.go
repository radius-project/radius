		...
		},
		{
			...
			validationErr: &v1.ErrorResponse{
				Error: v1.ErrorDetails{
					...
					Message: "API version '2022-06-20-privatepreview' for type 'applications.core/environments' is not supported. The supported api-versions are '2023-04-15-preview'.",
				},
			},
		},
		{
