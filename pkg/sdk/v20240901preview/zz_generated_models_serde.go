...
// MarshalJSON implements the json.Marshaller interface for type NGroupContainerGroupPropertiesContainersItem.
func (n NGroupContainerGroupPropertiesContainersItem) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "name", n.Name)
	populate(objectMap, "properties", n.Properties)
	return json.Marshal(objectMap)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type NGroupContainerGroupPropertiesContainersItem.
func (n *NGroupContainerGroupPropertiesContainersItem) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", n, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type NGroupContainerGroupPropertiesContainersItemAutoGenerated.
func (n NGroupContainerGroupPropertiesContainersItemAutoGenerated) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
	populate(objectMap, "volumeMounts", n.VolumeMounts)
	return json.Marshal(objectMap)
}

// UnmarshalJSON implements the json.Unmarshaller interface for type NGroupContainerGroupPropertiesContainersItemAutoGenerated.
func (n *NGroupContainerGroupPropertiesContainersItemAutoGenerated) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", n, err)
	}
...
// MarshalJSON implements the json.Marshaller interface for type NGroupContainerGroupPropertiesVolumesItem.
func (n NGroupContainerGroupPropertiesVolumesItem) MarshalJSON() ([]byte, error) {
	objectMap := make(map[string]any)
...
// UnmarshalJSON implements the json.Unmarshaller interface for type NGroupContainerGroupPropertiesVolumesItem.
func (n *NGroupContainerGroupPropertiesVolumesItem) UnmarshalJSON(data []byte) error {
	var rawMsg map[string]json.RawMessage
	if err := json.Unmarshal(data, &rawMsg); err != nil {
		return fmt.Errorf("unmarshalling type %T: %v", n, err)
	}
