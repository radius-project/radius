...
// BeginCreateOrUpdate - Create or update a nGroup.
...
// CreateOrUpdate - Create or update a nGroup.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-09-01-preview
func (client *NGroupsClient) createOrUpdate(ctx context.Context, resourceGroupName string, ngroupsName string, nGroup NGroup, options *NGroupsClientBeginCreateOrUpdateOptions) (*http.Response, error) {
	var err error
	ctx, endSpan := runtime.StartSpan(ctx, "NGroupsClient.BeginCreateOrUpdate", client.internal.Tracer(), nil)
...
func (client *NGroupsClient) deleteOperation(ctx context.Context, resourceGroupName string, ngroupsName string, options *NGroupsClientBeginDeleteOptions) (*http.Response, error) {
	var err error
	ctx, endSpan := runtime.StartSpan(ctx, "NGroupsClient.BeginDelete", client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
...
// Get - Get the properties of the specified n group.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-09-01-preview
//   - resourceGroupName - The name of the resource group.
...
func (client *NGroupsClient) Get(ctx context.Context, resourceGroupName string, ngroupsName string, options *NGroupsClientGetOptions) (NGroupsClientGetResponse, error) {
	var err error
	ctx, endSpan := runtime.StartSpan(ctx, "NGroupsClient.Get", client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
...
// NewListPager - Gets a list of all nGroups under a subscription.
//
// Generated from API version 2024-09-01-preview
...
// NewListByResourceGroupPager - Gets a list of all nGroups under a resource group.
//
// Generated from API version 2024-09-01-preview
//   - resourceGroupName - The name of the resource group.
...
// BeginRestart - Restarts all container groups in a nGroup in place. If container image has updates, new image will be downloaded.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-09-01-preview
//   - resourceGroupName - The name of the resource group.
...
// Restart - Restarts all container groups in a nGroup in place. If container image has updates, new image will be downloaded.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-09-01-preview
func (client *NGroupsClient) restart(ctx context.Context, resourceGroupName string, ngroupsName string, options *NGroupsClientBeginRestartOptions) (*http.Response, error) {
	var err error
	ctx, endSpan := runtime.StartSpan(ctx, "NGroupsClient.BeginRestart", client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
...
// BeginStart - Starts all container groups in a nGroup. Compute resources will be allocated and billing will start.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-09-01-preview
//   - resourceGroupName - The name of the resource group.
...
// Start - Starts all container groups in a nGroup. Compute resources will be allocated and billing will start.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-09-01-preview
func (client *NGroupsClient) start(ctx context.Context, resourceGroupName string, ngroupsName string, options *NGroupsClientBeginStartOptions) (*http.Response, error) {
	var err error
	ctx, endSpan := runtime.StartSpan(ctx, "NGroupsClient.BeginStart", client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
...
// Stop - Stops all container groups in a nGroup. Compute resources will be deallocated and billing will stop.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-09-01-preview
//   - resourceGroupName - The name of the resource group.
...
func (client *NGroupsClient) Stop(ctx context.Context, resourceGroupName string, ngroupsName string, options *NGroupsClientStopOptions) (NGroupsClientStopResponse, error) {
	var err error
	ctx, endSpan := runtime.StartSpan(ctx, "NGroupsClient.Stop", client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
...
// BeginUpdate - Update a specified nGroup.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-09-01-preview
//   - resourceGroupName - The name of the resource group.
...
// Update - Update a specified nGroup.
// If the operation fails it returns an *azcore.ResponseError type.
//
// Generated from API version 2024-09-01-preview
func (client *NGroupsClient) update(ctx context.Context, resourceGroupName string, ngroupsName string, nGroup NGroup, options *NGroupsClientBeginUpdateOptions) (*http.Response, error) {
	var err error
	ctx, endSpan := runtime.StartSpan(ctx, "NGroupsClient.BeginUpdate", client.internal.Tracer(), nil)
	defer func() { endSpan(err) }()
