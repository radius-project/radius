...
// StateStoreDataModelFromVersioned converts version agnostic DaprStateStore datamodel to versioned model.
...
// StateStoreDataModelToVersioned converts versioned DaprStateStore model to datamodel.
