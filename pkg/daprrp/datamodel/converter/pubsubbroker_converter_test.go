	...
	}{
		{
			...
			&v20231001preview.DaprPubSubBrokerResource{
				...
				Properties: &v20231001preview.DaprPubSubBrokerProperties{
					Environment: new("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/radius-test-rg/providers/Applications.Core/environments/test-env"),
					Application: new("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/radius-test-rg/providers/Applications.Core/applications/test-app"),
					...
					Resources: []*v20231001preview.ResourceReference{
						{
							ID: new("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/testGroup/providers/Microsoft.ServiceBus/namespaces/radius-eastus-async"),
						},
					},
					Type:              new("pubsub.azure.servicebus"),
					Version:           new("v1"),
					ComponentName:     new("test-dpsb"),
					...
					Auth: &v20231001preview.DaprResourceAuth{
						SecretStore: new("test-secret-store"),
					},
				},
				Tags: map[string]*string{
					"env": new("dev"),
				},
				ID:   new("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/radius-test-rg/providers/Applications.Dapr/pubSubBrokers/test-dpsb"),
				Name: new("test-dpsb"),
				SystemData: &v20231001preview.SystemData{
					CreatedAt:          &createdAt,
					CreatedBy:          new("fakeid@live.com"),
					CreatedByType:      to.Ptr(v20231001preview.CreatedByTypeUser),
					LastModifiedAt:     &lastModifiedAt,
					LastModifiedBy:     new("fakeid@live.com"),
					LastModifiedByType: to.Ptr(v20231001preview.CreatedByTypeUser),
				},
				Type: new("Applications.Dapr/pubSubBrokers"),
			},
			nil,
		},
		{
