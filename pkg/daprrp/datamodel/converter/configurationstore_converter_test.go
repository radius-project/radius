	...
	}{
		{
			...
			&v20231001preview.DaprConfigurationStoreResource{
				...
				Properties: &v20231001preview.DaprConfigurationStoreProperties{
					...
					Type:              new("configuration.azure.appconfig"),
					Version:           new("v1"),
					ComponentName:     new("test-dcs"),
				...
				ID:   new("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/radius-test-rg/providers/Applications.Dapr/configurationStores/test-dcs"),
				Name: new("test-dcs"),
				...
				Type: new("Applications.Dapr/configurationStores"),
			},
			nil,
		},
		{
