...
import (
	...
	"github.com/radius-project/radius/pkg/linkrp/handlers"
	"github.com/radius-project/radius/pkg/linkrp/processors"
	"github.com/radius-project/radius/pkg/linkrp/renderers/dapr"
...
func (p *Processor) Process(ctx context.Context, resource *datamodel.DaprPubSubBroker, options processors.Options) error {
	...
	err = handlers.CheckDaprResourceNameUniqueness(ctx, p.Client, resource.Properties.ComponentName, options.RuntimeConfiguration.Kubernetes.Namespace, resource.Name, linkrp.N_DaprPubSubBrokersResourceType)
	if err != nil {
