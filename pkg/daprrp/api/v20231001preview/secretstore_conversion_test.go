	...
	}{
		{
			...
			expected: &DaprSecretStoreResource{
				...
				Properties: &DaprSecretStoreProperties{
					...
					Type:                 new("secretstores.hashicorp.vault"),
					Version:              new("v1"),
					ComponentName:        new("test-dss"),
				...
				ID:   new("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/radius-test-rg/providers/Applications.Dapr/secretStores/test-dss"),
				Name: new("test-dss"),
				Type: to.Ptr(dapr_ctrl.DaprSecretStoresResourceType),
			},
		},
		{
