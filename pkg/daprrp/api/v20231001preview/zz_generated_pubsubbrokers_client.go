...
func NewPubSubBrokersClient(credential azcore.TokenCredential, options *arm.ClientOptions) (*PubSubBrokersClient, error) {
...
//     method.
func (client *PubSubBrokersClient) BeginCreateOrUpdate(ctx context.Context, rootScope string, pubSubBrokerName string, resource DaprPubSubBrokerResource, options *PubSubBrokersClientBeginCreateOrUpdateOptions) (*runtime.Poller[PubSubBrokersClientCreateOrUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.createOrUpdate(ctx, rootScope, pubSubBrokerName, resource, options)
		if err != nil {
			return nil, err
		}
...
// If the operation fails it returns an *azcore.ResponseError type.
func (client *PubSubBrokersClient) createOrUpdate(ctx context.Context, rootScope string, pubSubBrokerName string, resource DaprPubSubBrokerResource, options *PubSubBrokersClientBeginCreateOrUpdateOptions) (*http.Response, error) {
	var err error
	req, err := client.createOrUpdateCreateRequest(ctx, rootScope, pubSubBrokerName, resource, options)
	if err != nil {
		return nil, err
	}
...
func (client *PubSubBrokersClient) createOrUpdateCreateRequest(ctx context.Context, rootScope string, pubSubBrokerName string, resource DaprPubSubBrokerResource, _ *PubSubBrokersClientBeginCreateOrUpdateOptions) (*policy.Request, error) {
...
//     method.
func (client *PubSubBrokersClient) BeginDelete(ctx context.Context, rootScope string, pubSubBrokerName string, options *PubSubBrokersClientBeginDeleteOptions) (*runtime.Poller[PubSubBrokersClientDeleteResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.deleteOperation(ctx, rootScope, pubSubBrokerName, options)
		if err != nil {
			return nil, err
		}
...
// If the operation fails it returns an *azcore.ResponseError type.
func (client *PubSubBrokersClient) deleteOperation(ctx context.Context, rootScope string, pubSubBrokerName string, options *PubSubBrokersClientBeginDeleteOptions) (*http.Response, error) {
	var err error
	req, err := client.deleteCreateRequest(ctx, rootScope, pubSubBrokerName, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *PubSubBrokersClient) deleteCreateRequest(ctx context.Context, rootScope string, pubSubBrokerName string, _ *PubSubBrokersClientBeginDeleteOptions) (*policy.Request, error) {
	urlPath := "/{rootScope}/providers/Applications.Dapr/pubSubBrokers/{pubSubBrokerName}"
	if rootScope == "" {
		return nil, errors.New("parameter rootScope cannot be empty")
	}
...
func (client *PubSubBrokersClient) Get(ctx context.Context, rootScope string, pubSubBrokerName string, options *PubSubBrokersClientGetOptions) (PubSubBrokersClientGetResponse, error) {
	var err error
	req, err := client.getCreateRequest(ctx, rootScope, pubSubBrokerName, options)
	if err != nil {
...
func (client *PubSubBrokersClient) getCreateRequest(ctx context.Context, rootScope string, pubSubBrokerName string, _ *PubSubBrokersClientGetOptions) (*policy.Request, error) {
	urlPath := "/{rootScope}/providers/Applications.Dapr/pubSubBrokers/{pubSubBrokerName}"
	if rootScope == "" {
		return nil, errors.New("parameter rootScope cannot be empty")
	}
...
//     method.
func (client *PubSubBrokersClient) NewListByScopePager(rootScope string, options *PubSubBrokersClientListByScopeOptions) *runtime.Pager[PubSubBrokersClientListByScopeResponse] {
...
//     method.
func (client *PubSubBrokersClient) BeginUpdate(ctx context.Context, rootScope string, pubSubBrokerName string, properties DaprPubSubBrokerResource, options *PubSubBrokersClientBeginUpdateOptions) (*runtime.Poller[PubSubBrokersClientUpdateResponse], error) {
	if options == nil || options.ResumeToken == "" {
		resp, err := client.update(ctx, rootScope, pubSubBrokerName, properties, options)
		if err != nil {
			return nil, err
		}
...
// If the operation fails it returns an *azcore.ResponseError type.
func (client *PubSubBrokersClient) update(ctx context.Context, rootScope string, pubSubBrokerName string, properties DaprPubSubBrokerResource, options *PubSubBrokersClientBeginUpdateOptions) (*http.Response, error) {
	var err error
	req, err := client.updateCreateRequest(ctx, rootScope, pubSubBrokerName, properties, options)
	if err != nil {
		return nil, err
	}
	httpResp, err := client.internal.Pipeline().Do(req)
...
func (client *PubSubBrokersClient) updateCreateRequest(ctx context.Context, rootScope string, pubSubBrokerName string, properties DaprPubSubBrokerResource, _ *PubSubBrokersClientBeginUpdateOptions) (*policy.Request, error) {
	urlPath := "/{rootScope}/providers/Applications.Dapr/pubSubBrokers/{pubSubBrokerName}"
	if rootScope == "" {
		return nil, errors.New("parameter rootScope cannot be empty")
	}
