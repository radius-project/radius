...
type SecretStoresServer struct{
	...
	BeginUpdate func(ctx context.Context, secretStoreName string, properties v20231001preview.DaprSecretStoreResourceUpdate, options *v20231001preview.SecretStoresClientBeginUpdateOptions) (resp azfake.PollerResponder[v20231001preview.SecretStoresClientUpdateResponse], errResp azfake.ErrorResponder)
...
func (s *SecretStoresServerTransport) dispatchBeginCreateOrUpdate(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/(?P<rootScope>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Applications\.Dapr/secretStores/(?P<secretStoreName>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
	if matches == nil || len(matches) < 2 {
		return nil, fmt.Errorf("failed to parse path %s", req.URL.Path)
	}
	body, err := server.UnmarshalRequestAsJSON[v20231001preview.DaprSecretStoreResource](req)
	if err != nil {
		return nil, err
	}
...
func (s *SecretStoresServerTransport) dispatchGet(req *http.Request) (*http.Response, error) {
	...
	resp, err := server.MarshalResponseAsJSON(respContent, server.GetResponse(respr).DaprSecretStoreResource, req)
	if err != nil {
		return nil, err
	}
	return resp, nil
...
func (s *SecretStoresServerTransport) dispatchNewListByScopePager(req *http.Request) (*http.Response, error) {
	...
	const regexStr = `/(?P<rootScope>[!#&$-;=?-\[\]_a-zA-Z0-9~%@]+)/providers/Applications\.Dapr/secretStores`
	regex := regexp.MustCompile(regexStr)
	matches := regex.FindStringSubmatch(req.URL.EscapedPath())
...
func (s *SecretStoresServerTransport) dispatchBeginUpdate(req *http.Request) (*http.Response, error) {
	...
	body, err := server.UnmarshalRequestAsJSON[v20231001preview.DaprSecretStoreResourceUpdate](req)
	if err != nil {
		return nil, err
	}
	secretStoreNameParam, err := url.PathUnescape(matches[regex.SubexpIndex("secretStoreName")])
