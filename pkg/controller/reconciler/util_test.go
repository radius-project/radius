...
func TestMakeKubernetesDeploymentResourceID(t *testing.T) {
	got := makeKubernetesDeploymentResourceID("attacker", "legitimate-app")
	require.Equal(t, "/planes/kubernetes/local/namespaces/attacker/providers/apps/Deployment/legitimate-app", got)
}
			...
			container: &v20231001preview.ContainerResource{
				Properties: &v20231001preview.ContainerProperties{
					Resources: []*v20231001preview.ResourceReference{{
						ID: to.Ptr("/planes/kubernetes/local/namespaces/attacker/providers/apps/Deployment/legitimate-app"),
					}},
				},
			},
			expectedResource: "/planes/kubernetes/local/namespaces/attacker/providers/apps/Deployment/legitimate-app",
			want:             true,
		},
		{
			...
			container: &v20231001preview.ContainerResource{
				Properties: &v20231001preview.ContainerProperties{
					Resources: []*v20231001preview.ResourceReference{{
						ID: to.Ptr("/planes/kubernetes/local/namespaces/victim/providers/apps/Deployment/victim-app"),
					}},
				},
			},
			expectedResource: "/planes/kubernetes/local/namespaces/attacker/providers/apps/Deployment/legitimate-app",
