...
// Source: github.com/project-radius/radius/pkg/queue/client (interfaces: Client)
...
// StartDequeuer mocks base method.
func (m *MockClient) StartDequeuer(arg0 context.Context, arg1 ...DequeueOptions) (<-chan *Message, error) {
	m.ctrl.T.Helper()
	varargs := []interface{}{arg0}
	for _, a := range arg1 {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "StartDequeuer", varargs...)
	ret0, _ := ret[0].(<-chan *Message)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// StartDequeuer indicates an expected call of StartDequeuer.
func (mr *MockClientMockRecorder) StartDequeuer(arg0 interface{}, arg1 ...interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]interface{}{arg0}, arg1...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StartDequeuer", reflect.TypeOf((*MockClient)(nil).StartDequeuer), varargs...)
}
