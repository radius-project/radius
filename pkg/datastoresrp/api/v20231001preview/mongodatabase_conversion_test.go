		...
		},
		{
			...
			expected: &datamodel.MongoDatabase{
				...
				Properties: datamodel.MongoDatabaseProperties{
					...
					Host:                 "testAccount.mongo.cosmos.azure.com",
					Port:                 10255,
					Recipe:               portableresources.ResourceRecipe{Name: "cosmosdb", Parameters: map[string]any{"foo": "bar"}},
				},
			},
		},
	...
	}{
		{
			...
			expected: &MongoDatabaseResource{
				...
				Properties: &MongoDatabaseProperties{
					...
					ResourceProvisioning: new(ResourceProvisioningManual),
					Host:                 new("testAccount1.mongo.cosmos.azure.com"),
					Port:                 new(int32(10255)),
					Database:             new("test-database"),
					ProvisioningState:    new(ProvisioningStateAccepted),
					Recipe:               &Recipe{Name: new(""), Parameters: nil},
				...
				ID:   new("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/radius-test-rg/providers/Applications.Datastores/mongoDatabases/mongo0"),
				Name: new("mongo0"),
		...
		},
		{
			...
			expected: &MongoDatabaseResource{
				...
				Properties: &MongoDatabaseProperties{
					...
					ProvisioningState:    new(ProvisioningStateAccepted),
					Recipe:               &Recipe{Name: new(""), Parameters: nil},
					Resources:            []*ResourceReference{{ID: new("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/radius-test-rg/providers/Microsoft.DocumentDB/databaseAccounts/testAccount/mongodbDatabases/db")}},
					Username:             new(""),
		...
		},
		{
			...
			expected: &MongoDatabaseResource{
				...
				Properties: &MongoDatabaseProperties{
					Environment:          new("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/radius-test-rg/providers/Applications.Core/environments/env0"),
					Application:          new("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/radius-test-rg/providers/Applications.Core/applications/testApplication"),
					ResourceProvisioning: new(ResourceProvisioningRecipe),
					Host:                 new("testAccount1.mongo.cosmos.azure.com"),
					Port:                 new(int32(10255)),
					Database:             new(""),
					ProvisioningState:    new(ProvisioningStateAccepted),
					Recipe:               &Recipe{Name: new("cosmosdb"), Parameters: map[string]any{"foo": "bar"}},
					Username:             new(""),
					Status: &ResourceStatus{
						OutputResources: nil,
						Recipe: &RecipeStatus{
							TemplateKind:    new("bicep"),
							TemplatePath:    new("br:sampleregistry.azureacr.io/radius/recipes/abc"),
							TemplateVersion: nil,
						},
					},
				},
