...
// OperationsServer is a fake server for instances of the v20231001preview.OperationsClient type.
type OperationsServer struct{
	// NewListPager is the fake for method OperationsClient.NewListPager
	// HTTP status codes to indicate success: http.StatusOK
	NewListPager func(options *v20231001preview.OperationsClientListOptions) (resp azfake.PagerResponder[v20231001preview.OperationsClientListResponse])

}

// NewOperationsServerTransport creates a new instance of OperationsServerTransport with the provided implementation.
// The returned OperationsServerTransport instance is connected to an instance of v20231001preview.OperationsClient via the
// azcore.ClientOptions.Transporter field in the client's constructor parameters.
func NewOperationsServerTransport(srv *OperationsServer) *OperationsServerTransport {
	return &OperationsServerTransport{
		srv: srv,
		newListPager: newTracker[azfake.PagerResponder[v20231001preview.OperationsClientListResponse]](),
	}
}

// OperationsServerTransport connects instances of v20231001preview.OperationsClient to instances of OperationsServer.
// Don't use this type directly, use NewOperationsServerTransport instead.
type OperationsServerTransport struct {
	srv *OperationsServer
	newListPager *tracker[azfake.PagerResponder[v20231001preview.OperationsClientListResponse]]
}
...
resp := o.srv.NewListPager(nil)
		...
		server.PagerResponderInjectNextLinks(newListPager, req, func(page *v20231001preview.OperationsClientListResponse, createLink func() string) {
