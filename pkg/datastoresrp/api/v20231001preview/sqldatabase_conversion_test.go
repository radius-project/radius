			...
			expected: &SQLDatabaseResource{
				...
				Properties: &SQLDatabaseProperties{
					...
					Resources: []*ResourceReference{
						{
							ID: new("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/radius-test-rg/providers/Microsoft.Sql/servers/testServer/databases/testDatabase"),
						},
					},
					Database:          new("testDatabase"),
					Server:            new("testAccount1.sql.cosmos.azure.com"),
					Port:              new(int32(1433)),
				...
				ID:   new("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/radius-test-rg/providers/Applications.Datastores/sqlDatabases/sql0"),
				Name: new("sql0"),
