	...
	}{
		{
			...
			expected: &RedisCacheResource{
				...
				Properties: &RedisCacheProperties{
					...
					Application:          new(ApplicationID),
					ResourceProvisioning: new(ResourceProvisioningManual),
					Host:                 new("myrediscache.redis.cache.windows.net"),
		...
		},
		{
			...
			expected: &RedisCacheResource{
				...
				Properties: &RedisCacheProperties{
					...
					Port:                 new(int32(0)),
					ProvisioningState:    new(ProvisioningStateAccepted),
					Recipe:               &Recipe{Name: new("redis-test"), Parameters: map[string]any{"port": float64(6081)}},
					Username:             new(""),
					TLS:                  new(false),
			...
			expected: &RedisCacheResource{
				...
				Properties: &RedisCacheProperties{
					...
					Resources: []*ResourceReference{
						{ID: new("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/radius-test-rg/providers/Microsoft.Cache/Redis/testCache")},
						{ID: new("/subscriptions/00000000-0000-0000-0000-000000000000/resourceGroups/radius-test-rg/providers/Microsoft.Cache/Redis/testCache1")},
					},
				},
				Tags: map[string]*string{
					"env": new("dev"),
