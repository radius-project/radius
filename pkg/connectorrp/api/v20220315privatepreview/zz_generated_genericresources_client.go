...
// ListSecrets - Lists secrets specified resource of specified type within the root scope
// If the operation fails it returns the *ErrorResponse error type.
func (client *GenericResourcesClient) ListSecrets(ctx context.Context, resourceName string, options *GenericResourcesListSecretsOptions) (GenericResourcesListSecretsResponse, error) {
	req, err := client.listSecretsCreateRequest(ctx, resourceName, options)
	if err != nil {
		return GenericResourcesListSecretsResponse{}, err
	}
	resp, err := 	client.pl.Do(req)
	if err != nil {
		return GenericResourcesListSecretsResponse{}, err
	...
	if !runtime.HasStatusCode(resp, http.StatusOK) {
		return GenericResourcesListSecretsResponse{}, client.listSecretsHandleError(resp)
	}
	return client.listSecretsHandleResponse(resp)
}

// listSecretsCreateRequest creates the ListSecrets request.
func (client *GenericResourcesClient) listSecretsCreateRequest(ctx context.Context, resourceName string, options *GenericResourcesListSecretsOptions) (*policy.Request, error) {
...
func (client *GenericResourcesClient) listSecretsHandleResponse(resp *http.Response) (GenericResourcesListSecretsResponse, error) {
	result := GenericResourcesListSecretsResponse{RawResponse: resp}
	if err := runtime.UnmarshalAsJSON(resp, &result.GenericResourceSecrets); err != nil {
		return GenericResourcesListSecretsResponse{}, err
	}
	return result, nil
}
...
func (client *GenericResourcesClient) listSecretsHandleError(resp *http.Response) error {
	body, err := runtime.Payload(resp)
	if err != nil {
		return runtime.NewResponseError(err, resp)
	}
