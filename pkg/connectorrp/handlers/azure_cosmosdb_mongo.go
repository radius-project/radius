...
func (handler *azureCosmosDBMongoHandler) Delete(ctx context.Context, resource *outputresource.OutputResource, identity *resourcemodel.ResourceIdentity) error {
	return nil
}
