...
func NewCreateOrUpdateRabbitMQMessageQueue(ds store.StorageClient, sm manager.StatusManager) (ctrl.Controller, error) {
	return &CreateOrUpdateRabbitMQMessageQueue{ctrl.NewBaseController(ds, sm)}, nil
}
