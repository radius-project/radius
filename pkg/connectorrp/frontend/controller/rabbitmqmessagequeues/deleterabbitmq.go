...
func NewDeleteRabbitMQMessageQueue(ds store.StorageClient, sm manager.StatusManager) (ctrl.Controller, error) {
	return &DeleteRabbitMQMessageQueue{ctrl.NewBaseController(ds, sm)}, nil
}
