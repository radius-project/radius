...
func TestListRabbitMQMessageQueuesRun_20220315PrivatePreview(t *testing.T) {
	...
	t.Run("empty list", func(t *testing.T) {
		...
		ctl, err := NewListRabbitMQMessageQueues(mStorageClient, nil, nil)
		...
		actualOutput := &v20220315privatepreview.RabbitMQMessageQueueList{}
	...
	testCases := []struct {
		...
		{"list-rabbitmq-more-items-than-max", 10, 5, "5", true},
		{"list-rabbitmq-less-items-than-max", 5, 5, "10", false},
		{"list-rabbitmq-no-max", 5, 5, "", false},
	}
