...
func NewListDaprPubSubBrokers(ds store.StorageClient, sm manager.StatusManager) (ctrl.Controller, error) {
	return &ListDaprPubSubBrokers{ctrl.NewBaseController(ds, sm)}, nil
}
