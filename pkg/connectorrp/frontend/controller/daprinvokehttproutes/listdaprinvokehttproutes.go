...
func NewListDaprInvokeHttpRoutes(ds store.StorageClient, sm manager.StatusManager) (ctrl.Controller, error) {
	return &ListDaprInvokeHttpRoutes{ctrl.NewBaseController(ds, sm)}, nil
}
