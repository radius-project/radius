...
func TestListDaprInvokeHttpRoutesRun_20220315PrivatePreview(t *testing.T) {
	...
	t.Run("empty list", func(t *testing.T) {
		...
		ctl, err := NewListDaprInvokeHttpRoutes(mStorageClient, nil, nil)
		...
		actualOutput := &v20220315privatepreview.DaprInvokeHTTPRouteList{}
	...
	testCases := []struct {
		...
		{"list-daprHttpRoute-more-items-than-max", 10, 5, "5", true},
		{"list-daprHttpRoute-less-items-than-max", 5, 5, "10", false},
		{"list-daprHttpRoute-no-max", 5, 5, "", false},
	}
