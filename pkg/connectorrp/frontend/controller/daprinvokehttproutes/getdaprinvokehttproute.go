...
func NewGetDaprInvokeHttpRoute(ds store.StorageClient, sm manager.StatusManager, dp deployment.DeploymentProcessor) (ctrl.Controller, error) {
	return &GetDaprInvokeHttpRoute{ctrl.NewBaseController(ds, sm, dp)}, nil
}
