...
func NewGetDaprInvokeHttpRoute(ds store.StorageClient, sm manager.StatusManager) (ctrl.Controller, error) {
	return &GetDaprInvokeHttpRoute{ctrl.NewBaseController(ds, sm)}, nil
}
