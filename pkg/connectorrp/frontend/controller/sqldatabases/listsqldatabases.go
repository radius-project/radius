...
func NewListSqlDatabases(ds store.StorageClient, sm manager.StatusManager) (ctrl.Controller, error) {
	return &ListSqlDatabases{ctrl.NewBaseController(ds, sm)}, nil
}
