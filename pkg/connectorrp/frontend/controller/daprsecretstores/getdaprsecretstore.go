...
func NewGetDaprSecretStore(ds store.StorageClient, sm manager.StatusManager, dp deployment.DeploymentProcessor) (ctrl.Controller, error) {
	return &GetDaprSecretStore{ctrl.NewBaseController(ds, sm, dp)}, nil
}
