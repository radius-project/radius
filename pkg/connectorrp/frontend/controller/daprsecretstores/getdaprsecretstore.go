...
func NewGetDaprSecretStore(ds store.StorageClient, sm manager.StatusManager) (ctrl.Controller, error) {
	return &GetDaprSecretStore{ctrl.NewBaseController(ds, sm)}, nil
}
