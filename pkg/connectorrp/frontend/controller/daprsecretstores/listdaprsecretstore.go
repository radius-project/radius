...
func NewListDaprSecretStores(ds store.StorageClient, sm manager.StatusManager) (ctrl.Controller, error) {
	return &ListDaprSecretStores{ctrl.NewBaseController(ds, sm)}, nil
}
