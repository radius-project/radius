...
func TestListDaprStateStoresRun_20220315PrivatePreview(t *testing.T) {
	...
	t.Run("empty list", func(t *testing.T) {
		...
		ctl, err := NewListDaprStateStores(mStorageClient, nil, nil)
	...
	testCases := []struct {
		...
		{"list-daprStateStore-more-items-than-max", 10, 5, "5", true},
		{"list-daprStateStore-less-items-than-max", 5, 5, "10", false},
		{"list-daprStateStore-no-max", 5, 5, "", false},
	}
