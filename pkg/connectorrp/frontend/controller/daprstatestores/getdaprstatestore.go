...
func NewGetDaprStateStore(ds store.StorageClient, sm manager.StatusManager) (ctrl.Controller, error) {
	return &GetDaprStateStore{ctrl.NewBaseController(ds, sm)}, nil
}
