...
### Publishing Radius assets to GitHub Releases
In order to move towards our open-source release, we are now publishing Radius assets to [GitHub Releases](https://docs.github.com/en/repositories/releasing-projects-on-github/about-releases) and [GitHub Container Registry](https://docs.github.com/en/packages/working-with-a-github-packages-registry/working-with-the-container-registry).

### `rad init` Experience
We have simplified the default `rad init` experience - now the CLI will detect and use defaults based on your local environment. To use the expanded experience, try `rad init --full`.

### `rad app connections`
We have created a new CLI command to visualize your application graph. Try out `rad app connections` to see the interactions between your Radius resources and cloud resources!
...
* Release v0.23.0 by @lakshmimsft in https://github.com/project-radius/radius/pull/5902
...
* Release: 0.24.0-rc1 by @willdavsmith in https://github.com/project-radius/radius/pull/6077
