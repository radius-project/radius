...
Today we're happy to announce the release of Radius v0.57.0. Check out the [highlights](#highlights) below, along with the [full changelog](#full-changelog) for more details.
...
* Release 0.56.0 by @brooke-hamilton in https://github.com/radius-project/radius/pull/11471
...
## New Contributors
* @zachcasper made their first contribution in https://github.com/radius-project/radius/pull/11651

**Full Changelog**: https://github.com/radius-project/radius/compare/v0.56.0-rc3...v0.57.0-rc1
