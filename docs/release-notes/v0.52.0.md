...
### Improved resource cleanup for uninstall command
The `rad uninstall kubernetes --purge` command now performs more thorough cleanup of resources, ensuring all Kubernetes resources created by Radius are deleted. For more details, see the [CLI documentation](https://docs.radapp.io/reference/cli/rad_uninstall_kubernetes/).
