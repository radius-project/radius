...
### Recipe Template Information in Resource Status
Recipe's template information is now available in the resource status. This information is useful to understand the template used to create the resource.

### Improved Error Messages
Error messages formatting have been improved to easy to read and understand.
